...
\begin{minipage}{.45\textwidth}
  \lstinputlisting[language={[concubine]Assembler}, caption=\texttt{thread.0.asm}, label={lst:program:thread.0.asm}, xleftmargin=0.39\textwidth]{../../examples/demo/processor.0.asm}
\end{minipage}
\begin{minipage}{.45\textwidth}
  \lstinputlisting[language={[concubine]Assembler}, caption=\texttt{thread.1.asm}, label={lst:program:thread.1.asm}, xleftmargin=0.39\textwidth]{../../examples/demo/processor.1.asm}
\end{minipage}
