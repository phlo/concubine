...
ConcuBinE\footnote{\url{https://github.com/phlo/concubine}} (\textbf{Concu}rrent \textbf{Bin}ary \textbf{E}valuator),
a toolchain for simulating and
% verifying
...
\end{itemize}
Figure \ref{fig:intro:toolchain} shows a basic overview of its usage, where red nodes symbolize in and output files, blue nodes the components according to the mode it is used and yellow nodes external software (SMT solvers).
