...
\begin{longtabu}{llX[m]}
  \firsthline
  \multirow{2}{*}{\lstinline[language={[concubine]Assembler}]{FLUSH}}
    & $\HEAP^{k + 1}$   & $= \WRITE^k(\SBADR^k_t, \SBVAL^k_t)$ \\
    & $\SBFULL^{k + 1}$ & $= \FALSE$ \\
  \hline
  % \hhline{===}
  % \tabucline[2pt off 2pt]{-}
  \multirow{3.05}{*}{\lstinline[language={[concubine]Assembler}]{LOAD arg}}
  ...
  % \multirow{2.5}{*}{\texttt{STORE adr}}
    ...
    % & $\STMT^k_{t, pc}$     & $= false$ \\
    % & $\STMT^k_{t, pc + 1}$ & $= true$ \\
  \multirow{4}{*}{\lstinline[language={[concubine]Assembler}]{STORE arg}}
  ...
  \hline
  % \hhline{===}
  \multirow{2}{*}{\lstinline[language={[concubine]Assembler}]{FENCE}}
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
  \hline
  \multirow{3.05}{*}{\lstinline[language={[concubine]Assembler}]{ADD arg}}
    & $\ACCU^{k + 1}_t$           & $= \ACCU^k_t + \LOAD^k_t(\texttt{arg})$ \\
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
  \hline
  \multirow{3.05}{*}{\lstinline[language={[concubine]Assembler}]{ADDI arg}}
    & $\ACCU^{k + 1}_t$           & $= \ACCU^k_t + \texttt{arg}$ \\
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
  \hline
  \multirow{3.05}{*}{\lstinline[language={[concubine]Assembler}]{SUB arg}}
    & $\ACCU^{k + 1}_t$           & $= \ACCU^k_t - \LOAD^k_t(\texttt{arg})$ \\
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
  \hline
  \multirow{3.05}{*}{\lstinline[language={[concubine]Assembler}]{SUBI arg}}
    & $\ACCU^{k + 1}_t$           & $= \ACCU^k_t - \texttt{arg}$ \\
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
  \hline
  \multirow{3.05}{*}{\lstinline[language={[concubine]Assembler}]{MUL arg}}
    & $\ACCU^{k + 1}_t$           & $= \ACCU^k_t * \LOAD^k_t(\texttt{arg})$ \\
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
  \hline
  \newpage
  \hline
  \multirow{3.05}{*}{\lstinline[language={[concubine]Assembler}]{MULI arg}}
    & $\ACCU^{k + 1}_t$           & $= \ACCU^k_t * \texttt{arg}$ \\
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
  \hline
  \multirow{3}{*}{\lstinline[language={[concubine]Assembler}]{CMP arg}}
    & $\ACCU^{k + 1}_t$           & $= \ACCU^k_t - \LOAD^k_t(\texttt{arg})$ \\
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
  \hline
  \multirow{2}{*}{\lstinline[language={[concubine]Assembler}]{JMP arg}}
    & $\STMT^{k + 1}_{t, pc}$           & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, \texttt{arg}}$ & $= \TRUE$ \\
  \hline
  \multirow{3}{*}{\lstinline[language={[concubine]Assembler}]{JZ arg}}
    & $\STMT^{k + 1}_{t, pc}$           & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$       & $= \ACCU^k_t$ \\
    & $\STMT^{k + 1}_{t, \texttt{arg}}$ & $= \lnot \ACCU^k_t$ \\
  \hline
  \multirow{3}{*}{\lstinline[language={[concubine]Assembler}]{JNZ arg}}
    & $\STMT^{k + 1}_{t, pc}$           & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$       & $= \lnot \ACCU^k_t$ \\
    & $\STMT^{k + 1}_{t, \texttt{arg}}$ & $= \ACCU^k_t$ \\
  \hline
  \multirow{3}{*}{\lstinline[language={[concubine]Assembler}]{JS arg}}
    & $\STMT^{k + 1}_{t, pc}$           & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$       & $= \lnot \MSB(\ACCU^k_t)$ \\
    & $\STMT^{k + 1}_{t, \texttt{arg}}$ & $= \MSB(\ACCU^k_t)$ \\
  \hline
  \multirow{3}{*}{\lstinline[language={[concubine]Assembler}]{JNS arg}}
    & $\STMT^{k + 1}_{t, pc}$           & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$       & $= \MSB(\ACCU^k_t)$ \\
    & $\STMT^{k + 1}_{t, \texttt{arg}}$ & $= \lnot \MSB(\ACCU^k_t)$ \\
  \hline
  \multirow{3}{*}{\lstinline[language={[concubine]Assembler}]{JNZNS arg}}
    & $\STMT^{k + 1}_{t, pc}$           & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$       & $= \lnot \ACCU^{k + 1}_t \lor \MSB(\ACCU^k_t)$ \\
    & $\STMT^{k + 1}_{t, \texttt{arg}}$ & $= \ACCU^{k + 1}_t \land \lnot \MSB(\ACCU^k_t)$ \\
  \hline
  \multirow{4}{*}{\lstinline[language={[concubine]Assembler}]{MEM arg}}
    & $\ACCU^{k + 1}_t$           & $= \LOAD^k_t(\texttt{arg})$ \\
  ...
  \multirow{2.97}{*}{\lstinline[language={[concubine]Assembler}]{CAS arg}}
    & $\HEAP^{k + 1}$             & $=$ \usebox{\CASHEAPAXIOM} \\
    & $\ACCU^{k + 1}_t$           & $=$ \usebox{\CASACCUAXIOM} \\
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
  \hline
  \multirow{2}{*}{\lstinline[language={[concubine]Assembler}]{HALT}}
    % & $\EXIT^{k + 1}_t$ & $= \HALT^{k + 1}_0 \land \ldots \land \HALT^{k + 1}_{n - 1}$ \\
    & $\EXIT^{k + 1}_t$       & $= \displaystyle \bigwedge^{n - 1}_{i = 0} \HALT^{k + 1}_i$ \\
    & $\HALT^{k + 1}_t$       & $= \TRUE$ \\
    & $\STMT^{k + 1}_{t, pc}$ & $= \FALSE$ \\
  \hline
  \multirow{3}{*}{\lstinline[language={[concubine]Assembler}]{EXIT arg}}
    & $\EXIT^{k + 1}_t$       & $= \TRUE$ \\
    & $\EXITCODE^k$           & \vspace{.15cm} $= \texttt{arg}$ \\
    & $\STMT^{k + 1}_{t, pc}$ & $= \FALSE$ \\
  \hline
  \multirow{3}{*}{\lstinline[language={[concubine]Assembler}]{CHECK arg}}
    & $\STMT^{k + 1}_{t, pc}$     & $= \FALSE$ \\
    & $\STMT^{k + 1}_{t, pc + 1}$ & $= \TRUE$ \\
...
\defencode{\lstinline[language={[concubine]Assembler}]{LOAD arg}}
...
\defencode{\lstinline[language={[concubine]Assembler}]{STORE arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{ADD arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{ADDI arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{SUB arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{SUBI arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{MUL arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{MULI arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{CMP arg}}
\begin{lstlisting}[style=c++, style=encode]
...
% \defencode{\lstinline[language={[concubine]Assembler}]{JMP arg}}
% \begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{JZ arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{JNZ arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{JS arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{JNS arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{JNZNS arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{MEM arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{CAS arg}}
\begin{lstlisting}[style=c++, style=encode]
...
% \subsubsection{encode HALT}
% \todo[inline]{encode HALT} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% \defencode{\lstinline[language={[concubine]Assembler}]{HALT}}
% \begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{EXIT arg}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{FENCE}}
\begin{lstlisting}[style=c++, style=encode]
...
\defencode{\lstinline[language={[concubine]Assembler}]{CHECK arg}}
\begin{lstlisting}[style=c++, style=encode]
