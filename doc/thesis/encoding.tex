...
$\CardLtSeq$ is superior to the na\"ive encoding with regard to the number of clauses for all $n > 5$, as it only requires $3n - 4$ \CHANGE{binary} clauses and $n - 1$ additional auxiliary variables.
