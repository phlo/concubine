...
; accu variables - accu_<step>_<thread>
(assert (= accu_1_0 (ite exec_0_0_0 (bvadd accu_0_0 #x0001) (ite exec_0_0_2 (ite (and sb-full_0_0 (= sb-adr_0_0 #x0001)) sb-val_0_0 (select heap_0 #x0001)) accu_0_0))))
(assert (= accu_1_1 (ite exec_0_1_0 (bvadd accu_0_1 #x0001) (ite exec_0_1_2 (ite (and sb-full_0_1 (= sb-adr_0_1 #x0000)) sb-val_0_1 (select heap_0 #x0000)) accu_0_1))))
(assert (= accu_1_2 (ite exec_0_2_1 (bvadd accu_0_2 (ite (and sb-full_0_2 (= sb-adr_0_2 #x0000)) sb-val_0_2 (select heap_0 #x0000))) (ite exec_0_2_2 (bvadd accu_0_2 (ite (and sb-full_0_2 (= sb-adr_0_2 #x0001)) sb-val_0_2 (select heap_0 #x0001))) accu_0_2))))
...
(assert (= stmt_1_2_3 (ite stmt_0_2_2 exec_0_2_2 (and stmt_0_2_3 (not exec_0_2_3)))))
(assert (= stmt_1_2_4 (ite stmt_0_2_3 (and exec_0_2_3 (not (= accu_0_2 #x0000))) (and stmt_0_2_4 (not exec_0_2_4)))))
(assert (= stmt_1_2_5 (ite stmt_0_2_3 (and exec_0_2_3 (= accu_0_2 #x0000)) (and stmt_0_2_5 (not exec_0_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_1_0_0 (ite check_0_0 false (or exec_0_0_3 block_0_0_0))))
(assert (= block_1_0_1 (ite check_0_0 false (or exec_0_1_3 block_0_0_1))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_2_0 (ite exec_1_0_0 (bvadd accu_1_0 #x0001) (ite exec_1_0_2 (ite (and sb-full_1_0 (= sb-adr_1_0 #x0001)) sb-val_1_0 (select heap_1 #x0001)) accu_1_0))))
(assert (= accu_2_1 (ite exec_1_1_0 (bvadd accu_1_1 #x0001) (ite exec_1_1_2 (ite (and sb-full_1_1 (= sb-adr_1_1 #x0000)) sb-val_1_1 (select heap_1 #x0000)) accu_1_1))))
(assert (= accu_2_2 (ite exec_1_2_1 (bvadd accu_1_2 (ite (and sb-full_1_2 (= sb-adr_1_2 #x0000)) sb-val_1_2 (select heap_1 #x0000))) (ite exec_1_2_2 (bvadd accu_1_2 (ite (and sb-full_1_2 (= sb-adr_1_2 #x0001)) sb-val_1_2 (select heap_1 #x0001))) accu_1_2))))
...
(assert (= stmt_2_2_4 (ite stmt_1_2_3 (and exec_1_2_3 (not (= accu_1_2 #x0000))) (and stmt_1_2_4 (not exec_1_2_4)))))
(assert (= stmt_2_2_5 (ite stmt_1_2_3 (and exec_1_2_3 (= accu_1_2 #x0000)) (and stmt_1_2_5 (not exec_1_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_2_0_0 (ite check_1_0 false (or exec_1_0_3 block_1_0_0))))
(assert (= block_2_0_1 (ite check_1_0 false (or exec_1_1_3 block_1_0_1))))
(assert (= block_2_0_2 (ite check_1_0 false (or exec_1_2_0 block_1_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_3_0 (ite exec_2_0_0 (bvadd accu_2_0 #x0001) (ite exec_2_0_2 (ite (and sb-full_2_0 (= sb-adr_2_0 #x0001)) sb-val_2_0 (select heap_2 #x0001)) accu_2_0))))
(assert (= accu_3_1 (ite exec_2_1_0 (bvadd accu_2_1 #x0001) (ite exec_2_1_2 (ite (and sb-full_2_1 (= sb-adr_2_1 #x0000)) sb-val_2_1 (select heap_2 #x0000)) accu_2_1))))
(assert (= accu_3_2 (ite exec_2_2_1 (bvadd accu_2_2 (ite (and sb-full_2_2 (= sb-adr_2_2 #x0000)) sb-val_2_2 (select heap_2 #x0000))) (ite exec_2_2_2 (bvadd accu_2_2 (ite (and sb-full_2_2 (= sb-adr_2_2 #x0001)) sb-val_2_2 (select heap_2 #x0001))) accu_2_2))))
...
(assert (= stmt_3_2_4 (ite stmt_2_2_3 (and exec_2_2_3 (not (= accu_2_2 #x0000))) (and stmt_2_2_4 (not exec_2_2_4)))))
(assert (= stmt_3_2_5 (ite stmt_2_2_3 (and exec_2_2_3 (= accu_2_2 #x0000)) (and stmt_2_2_5 (not exec_2_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_3_0_0 (ite check_2_0 false (or exec_2_0_3 block_2_0_0))))
(assert (= block_3_0_1 (ite check_2_0 false (or exec_2_1_3 block_2_0_1))))
(assert (= block_3_0_2 (ite check_2_0 false (or exec_2_2_0 block_2_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_4_0 (ite exec_3_0_0 (bvadd accu_3_0 #x0001) (ite exec_3_0_2 (ite (and sb-full_3_0 (= sb-adr_3_0 #x0001)) sb-val_3_0 (select heap_3 #x0001)) accu_3_0))))
(assert (= accu_4_1 (ite exec_3_1_0 (bvadd accu_3_1 #x0001) (ite exec_3_1_2 (ite (and sb-full_3_1 (= sb-adr_3_1 #x0000)) sb-val_3_1 (select heap_3 #x0000)) accu_3_1))))
(assert (= accu_4_2 (ite exec_3_2_1 (bvadd accu_3_2 (ite (and sb-full_3_2 (= sb-adr_3_2 #x0000)) sb-val_3_2 (select heap_3 #x0000))) (ite exec_3_2_2 (bvadd accu_3_2 (ite (and sb-full_3_2 (= sb-adr_3_2 #x0001)) sb-val_3_2 (select heap_3 #x0001))) accu_3_2))))
...
(assert (= stmt_4_2_4 (ite stmt_3_2_3 (and exec_3_2_3 (not (= accu_3_2 #x0000))) (and stmt_3_2_4 (not exec_3_2_4)))))
(assert (= stmt_4_2_5 (ite stmt_3_2_3 (and exec_3_2_3 (= accu_3_2 #x0000)) (and stmt_3_2_5 (not exec_3_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_4_0_0 (ite check_3_0 false (or exec_3_0_3 block_3_0_0))))
(assert (= block_4_0_1 (ite check_3_0 false (or exec_3_1_3 block_3_0_1))))
(assert (= block_4_0_2 (ite check_3_0 false (or exec_3_2_0 block_3_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_5_0 (ite exec_4_0_0 (bvadd accu_4_0 #x0001) (ite exec_4_0_2 (ite (and sb-full_4_0 (= sb-adr_4_0 #x0001)) sb-val_4_0 (select heap_4 #x0001)) accu_4_0))))
(assert (= accu_5_1 (ite exec_4_1_0 (bvadd accu_4_1 #x0001) (ite exec_4_1_2 (ite (and sb-full_4_1 (= sb-adr_4_1 #x0000)) sb-val_4_1 (select heap_4 #x0000)) accu_4_1))))
(assert (= accu_5_2 (ite exec_4_2_1 (bvadd accu_4_2 (ite (and sb-full_4_2 (= sb-adr_4_2 #x0000)) sb-val_4_2 (select heap_4 #x0000))) (ite exec_4_2_2 (bvadd accu_4_2 (ite (and sb-full_4_2 (= sb-adr_4_2 #x0001)) sb-val_4_2 (select heap_4 #x0001))) accu_4_2))))
...
(assert (= stmt_5_2_4 (ite stmt_4_2_3 (and exec_4_2_3 (not (= accu_4_2 #x0000))) (and stmt_4_2_4 (not exec_4_2_4)))))
(assert (= stmt_5_2_5 (ite stmt_4_2_3 (and exec_4_2_3 (= accu_4_2 #x0000)) (and stmt_4_2_5 (not exec_4_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_5_0_0 (ite check_4_0 false (or exec_4_0_3 block_4_0_0))))
(assert (= block_5_0_1 (ite check_4_0 false (or exec_4_1_3 block_4_0_1))))
(assert (= block_5_0_2 (ite check_4_0 false (or exec_4_2_0 block_4_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_6_0 (ite exec_5_0_0 (bvadd accu_5_0 #x0001) (ite exec_5_0_2 (ite (and sb-full_5_0 (= sb-adr_5_0 #x0001)) sb-val_5_0 (select heap_5 #x0001)) accu_5_0))))
(assert (= accu_6_1 (ite exec_5_1_0 (bvadd accu_5_1 #x0001) (ite exec_5_1_2 (ite (and sb-full_5_1 (= sb-adr_5_1 #x0000)) sb-val_5_1 (select heap_5 #x0000)) accu_5_1))))
(assert (= accu_6_2 (ite exec_5_2_1 (bvadd accu_5_2 (ite (and sb-full_5_2 (= sb-adr_5_2 #x0000)) sb-val_5_2 (select heap_5 #x0000))) (ite exec_5_2_2 (bvadd accu_5_2 (ite (and sb-full_5_2 (= sb-adr_5_2 #x0001)) sb-val_5_2 (select heap_5 #x0001))) accu_5_2))))
...
(assert (= stmt_6_2_4 (ite stmt_5_2_3 (and exec_5_2_3 (not (= accu_5_2 #x0000))) (and stmt_5_2_4 (not exec_5_2_4)))))
(assert (= stmt_6_2_5 (ite stmt_5_2_3 (and exec_5_2_3 (= accu_5_2 #x0000)) (and stmt_5_2_5 (not exec_5_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_6_0_0 (ite check_5_0 false (or exec_5_0_3 block_5_0_0))))
(assert (= block_6_0_1 (ite check_5_0 false (or exec_5_1_3 block_5_0_1))))
(assert (= block_6_0_2 (ite check_5_0 false (or exec_5_2_0 block_5_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_7_0 (ite exec_6_0_0 (bvadd accu_6_0 #x0001) (ite exec_6_0_2 (ite (and sb-full_6_0 (= sb-adr_6_0 #x0001)) sb-val_6_0 (select heap_6 #x0001)) accu_6_0))))
(assert (= accu_7_1 (ite exec_6_1_0 (bvadd accu_6_1 #x0001) (ite exec_6_1_2 (ite (and sb-full_6_1 (= sb-adr_6_1 #x0000)) sb-val_6_1 (select heap_6 #x0000)) accu_6_1))))
(assert (= accu_7_2 (ite exec_6_2_1 (bvadd accu_6_2 (ite (and sb-full_6_2 (= sb-adr_6_2 #x0000)) sb-val_6_2 (select heap_6 #x0000))) (ite exec_6_2_2 (bvadd accu_6_2 (ite (and sb-full_6_2 (= sb-adr_6_2 #x0001)) sb-val_6_2 (select heap_6 #x0001))) accu_6_2))))
...
(assert (= stmt_7_2_4 (ite stmt_6_2_3 (and exec_6_2_3 (not (= accu_6_2 #x0000))) (and stmt_6_2_4 (not exec_6_2_4)))))
(assert (= stmt_7_2_5 (ite stmt_6_2_3 (and exec_6_2_3 (= accu_6_2 #x0000)) (and stmt_6_2_5 (not exec_6_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_7_0_0 (ite check_6_0 false (or exec_6_0_3 block_6_0_0))))
(assert (= block_7_0_1 (ite check_6_0 false (or exec_6_1_3 block_6_0_1))))
(assert (= block_7_0_2 (ite check_6_0 false (or exec_6_2_0 block_6_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_8_0 (ite exec_7_0_0 (bvadd accu_7_0 #x0001) (ite exec_7_0_2 (ite (and sb-full_7_0 (= sb-adr_7_0 #x0001)) sb-val_7_0 (select heap_7 #x0001)) accu_7_0))))
(assert (= accu_8_1 (ite exec_7_1_0 (bvadd accu_7_1 #x0001) (ite exec_7_1_2 (ite (and sb-full_7_1 (= sb-adr_7_1 #x0000)) sb-val_7_1 (select heap_7 #x0000)) accu_7_1))))
(assert (= accu_8_2 (ite exec_7_2_1 (bvadd accu_7_2 (ite (and sb-full_7_2 (= sb-adr_7_2 #x0000)) sb-val_7_2 (select heap_7 #x0000))) (ite exec_7_2_2 (bvadd accu_7_2 (ite (and sb-full_7_2 (= sb-adr_7_2 #x0001)) sb-val_7_2 (select heap_7 #x0001))) accu_7_2))))
...
(assert (= stmt_8_2_4 (ite stmt_7_2_3 (and exec_7_2_3 (not (= accu_7_2 #x0000))) (and stmt_7_2_4 (not exec_7_2_4)))))
(assert (= stmt_8_2_5 (ite stmt_7_2_3 (and exec_7_2_3 (= accu_7_2 #x0000)) (and stmt_7_2_5 (not exec_7_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_8_0_0 (ite check_7_0 false (or exec_7_0_3 block_7_0_0))))
(assert (= block_8_0_1 (ite check_7_0 false (or exec_7_1_3 block_7_0_1))))
(assert (= block_8_0_2 (ite check_7_0 false (or exec_7_2_0 block_7_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_9_0 (ite exec_8_0_0 (bvadd accu_8_0 #x0001) (ite exec_8_0_2 (ite (and sb-full_8_0 (= sb-adr_8_0 #x0001)) sb-val_8_0 (select heap_8 #x0001)) accu_8_0))))
(assert (= accu_9_1 (ite exec_8_1_0 (bvadd accu_8_1 #x0001) (ite exec_8_1_2 (ite (and sb-full_8_1 (= sb-adr_8_1 #x0000)) sb-val_8_1 (select heap_8 #x0000)) accu_8_1))))
(assert (= accu_9_2 (ite exec_8_2_1 (bvadd accu_8_2 (ite (and sb-full_8_2 (= sb-adr_8_2 #x0000)) sb-val_8_2 (select heap_8 #x0000))) (ite exec_8_2_2 (bvadd accu_8_2 (ite (and sb-full_8_2 (= sb-adr_8_2 #x0001)) sb-val_8_2 (select heap_8 #x0001))) accu_8_2))))

; mem variables - mem_<step>_<thread>
(assert (= mem_9_0 mem_8_0))
(assert (= mem_9_1 mem_8_1))
(assert (= mem_9_2 mem_8_2))
...
(assert (= stmt_9_2_4 (ite stmt_8_2_3 (and exec_8_2_3 (not (= accu_8_2 #x0000))) (and stmt_8_2_4 (not exec_8_2_4)))))
(assert (= stmt_9_2_5 (ite stmt_8_2_3 (and exec_8_2_3 (= accu_8_2 #x0000)) (and stmt_8_2_5 (not exec_8_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_9_0_0 (ite check_8_0 false (or exec_8_0_3 block_8_0_0))))
(assert (= block_9_0_1 (ite check_8_0 false (or exec_8_1_3 block_8_0_1))))
(assert (= block_9_0_2 (ite check_8_0 false (or exec_8_2_0 block_8_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_10_0 (ite exec_9_0_0 (bvadd accu_9_0 #x0001) (ite exec_9_0_2 (ite (and sb-full_9_0 (= sb-adr_9_0 #x0001)) sb-val_9_0 (select heap_9 #x0001)) accu_9_0))))
(assert (= accu_10_1 (ite exec_9_1_0 (bvadd accu_9_1 #x0001) (ite exec_9_1_2 (ite (and sb-full_9_1 (= sb-adr_9_1 #x0000)) sb-val_9_1 (select heap_9 #x0000)) accu_9_1))))
(assert (= accu_10_2 (ite exec_9_2_1 (bvadd accu_9_2 (ite (and sb-full_9_2 (= sb-adr_9_2 #x0000)) sb-val_9_2 (select heap_9 #x0000))) (ite exec_9_2_2 (bvadd accu_9_2 (ite (and sb-full_9_2 (= sb-adr_9_2 #x0001)) sb-val_9_2 (select heap_9 #x0001))) accu_9_2))))

; mem variables - mem_<step>_<thread>
(assert (= mem_10_0 mem_9_0))
(assert (= mem_10_1 mem_9_1))
(assert (= mem_10_2 mem_9_2))
...
(assert (= stmt_10_2_4 (ite stmt_9_2_3 (and exec_9_2_3 (not (= accu_9_2 #x0000))) (and stmt_9_2_4 (not exec_9_2_4)))))
(assert (= stmt_10_2_5 (ite stmt_9_2_3 (and exec_9_2_3 (= accu_9_2 #x0000)) (and stmt_9_2_5 (not exec_9_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_10_0_0 (ite check_9_0 false (or exec_9_0_3 block_9_0_0))))
(assert (= block_10_0_1 (ite check_9_0 false (or exec_9_1_3 block_9_0_1))))
(assert (= block_10_0_2 (ite check_9_0 false (or exec_9_2_0 block_9_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_11_0 (ite exec_10_0_0 (bvadd accu_10_0 #x0001) (ite exec_10_0_2 (ite (and sb-full_10_0 (= sb-adr_10_0 #x0001)) sb-val_10_0 (select heap_10 #x0001)) accu_10_0))))
(assert (= accu_11_1 (ite exec_10_1_0 (bvadd accu_10_1 #x0001) (ite exec_10_1_2 (ite (and sb-full_10_1 (= sb-adr_10_1 #x0000)) sb-val_10_1 (select heap_10 #x0000)) accu_10_1))))
(assert (= accu_11_2 (ite exec_10_2_1 (bvadd accu_10_2 (ite (and sb-full_10_2 (= sb-adr_10_2 #x0000)) sb-val_10_2 (select heap_10 #x0000))) (ite exec_10_2_2 (bvadd accu_10_2 (ite (and sb-full_10_2 (= sb-adr_10_2 #x0001)) sb-val_10_2 (select heap_10 #x0001))) accu_10_2))))

; mem variables - mem_<step>_<thread>
(assert (= mem_11_0 mem_10_0))
(assert (= mem_11_1 mem_10_1))
(assert (= mem_11_2 mem_10_2))
...
(assert (= stmt_11_2_4 (ite stmt_10_2_3 (and exec_10_2_3 (not (= accu_10_2 #x0000))) (and stmt_10_2_4 (not exec_10_2_4)))))
(assert (= stmt_11_2_5 (ite stmt_10_2_3 (and exec_10_2_3 (= accu_10_2 #x0000)) (and stmt_10_2_5 (not exec_10_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_11_0_0 (ite check_10_0 false (or exec_10_0_3 block_10_0_0))))
(assert (= block_11_0_1 (ite check_10_0 false (or exec_10_1_3 block_10_0_1))))
(assert (= block_11_0_2 (ite check_10_0 false (or exec_10_2_0 block_10_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_12_0 (ite exec_11_0_0 (bvadd accu_11_0 #x0001) (ite exec_11_0_2 (ite (and sb-full_11_0 (= sb-adr_11_0 #x0001)) sb-val_11_0 (select heap_11 #x0001)) accu_11_0))))
(assert (= accu_12_1 (ite exec_11_1_0 (bvadd accu_11_1 #x0001) (ite exec_11_1_2 (ite (and sb-full_11_1 (= sb-adr_11_1 #x0000)) sb-val_11_1 (select heap_11 #x0000)) accu_11_1))))
(assert (= accu_12_2 (ite exec_11_2_1 (bvadd accu_11_2 (ite (and sb-full_11_2 (= sb-adr_11_2 #x0000)) sb-val_11_2 (select heap_11 #x0000))) (ite exec_11_2_2 (bvadd accu_11_2 (ite (and sb-full_11_2 (= sb-adr_11_2 #x0001)) sb-val_11_2 (select heap_11 #x0001))) accu_11_2))))

; mem variables - mem_<step>_<thread>
(assert (= mem_12_0 mem_11_0))
(assert (= mem_12_1 mem_11_1))
(assert (= mem_12_2 mem_11_2))
...
(assert (= stmt_12_2_4 (ite stmt_11_2_3 (and exec_11_2_3 (not (= accu_11_2 #x0000))) (and stmt_11_2_4 (not exec_11_2_4)))))
(assert (= stmt_12_2_5 (ite stmt_11_2_3 (and exec_11_2_3 (= accu_11_2 #x0000)) (and stmt_11_2_5 (not exec_11_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_12_0_0 (ite check_11_0 false (or exec_11_0_3 block_11_0_0))))
(assert (= block_12_0_1 (ite check_11_0 false (or exec_11_1_3 block_11_0_1))))
(assert (= block_12_0_2 (ite check_11_0 false (or exec_11_2_0 block_11_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_13_0 (ite exec_12_0_0 (bvadd accu_12_0 #x0001) (ite exec_12_0_2 (ite (and sb-full_12_0 (= sb-adr_12_0 #x0001)) sb-val_12_0 (select heap_12 #x0001)) accu_12_0))))
(assert (= accu_13_1 (ite exec_12_1_0 (bvadd accu_12_1 #x0001) (ite exec_12_1_2 (ite (and sb-full_12_1 (= sb-adr_12_1 #x0000)) sb-val_12_1 (select heap_12 #x0000)) accu_12_1))))
(assert (= accu_13_2 (ite exec_12_2_1 (bvadd accu_12_2 (ite (and sb-full_12_2 (= sb-adr_12_2 #x0000)) sb-val_12_2 (select heap_12 #x0000))) (ite exec_12_2_2 (bvadd accu_12_2 (ite (and sb-full_12_2 (= sb-adr_12_2 #x0001)) sb-val_12_2 (select heap_12 #x0001))) accu_12_2))))

; mem variables - mem_<step>_<thread>
(assert (= mem_13_0 mem_12_0))
(assert (= mem_13_1 mem_12_1))
(assert (= mem_13_2 mem_12_2))
...
(assert (= stmt_13_2_3 (ite stmt_12_2_2 exec_12_2_2 (and stmt_12_2_3 (not exec_12_2_3)))))
(assert (= stmt_13_2_4 (ite stmt_12_2_3 (and exec_12_2_3 (not (= accu_12_2 #x0000))) (and stmt_12_2_4 (not exec_12_2_4)))))
(assert (= stmt_13_2_5 (ite stmt_12_2_3 (and exec_12_2_3 (= accu_12_2 #x0000)) (and stmt_12_2_5 (not exec_12_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_13_0_0 (ite check_12_0 false (or exec_12_0_3 block_12_0_0))))
(assert (= block_13_0_1 (ite check_12_0 false (or exec_12_1_3 block_12_0_1))))
(assert (= block_13_0_2 (ite check_12_0 false (or exec_12_2_0 block_12_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_14_0 (ite exec_13_0_0 (bvadd accu_13_0 #x0001) (ite exec_13_0_2 (ite (and sb-full_13_0 (= sb-adr_13_0 #x0001)) sb-val_13_0 (select heap_13 #x0001)) accu_13_0))))
(assert (= accu_14_1 (ite exec_13_1_0 (bvadd accu_13_1 #x0001) (ite exec_13_1_2 (ite (and sb-full_13_1 (= sb-adr_13_1 #x0000)) sb-val_13_1 (select heap_13 #x0000)) accu_13_1))))
(assert (= accu_14_2 (ite exec_13_2_1 (bvadd accu_13_2 (ite (and sb-full_13_2 (= sb-adr_13_2 #x0000)) sb-val_13_2 (select heap_13 #x0000))) (ite exec_13_2_2 (bvadd accu_13_2 (ite (and sb-full_13_2 (= sb-adr_13_2 #x0001)) sb-val_13_2 (select heap_13 #x0001))) accu_13_2))))

; mem variables - mem_<step>_<thread>
(assert (= mem_14_0 mem_13_0))
(assert (= mem_14_1 mem_13_1))
(assert (= mem_14_2 mem_13_2))
...
(assert (= stmt_14_2_3 (ite stmt_13_2_2 exec_13_2_2 (and stmt_13_2_3 (not exec_13_2_3)))))
(assert (= stmt_14_2_4 (ite stmt_13_2_3 (and exec_13_2_3 (not (= accu_13_2 #x0000))) (and stmt_13_2_4 (not exec_13_2_4)))))
(assert (= stmt_14_2_5 (ite stmt_13_2_3 (and exec_13_2_3 (= accu_13_2 #x0000)) (and stmt_13_2_5 (not exec_13_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_14_0_0 (ite check_13_0 false (or exec_13_0_3 block_13_0_0))))
(assert (= block_14_0_1 (ite check_13_0 false (or exec_13_1_3 block_13_0_1))))
(assert (= block_14_0_2 (ite check_13_0 false (or exec_13_2_0 block_13_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_15_0 (ite exec_14_0_0 (bvadd accu_14_0 #x0001) (ite exec_14_0_2 (ite (and sb-full_14_0 (= sb-adr_14_0 #x0001)) sb-val_14_0 (select heap_14 #x0001)) accu_14_0))))
(assert (= accu_15_1 (ite exec_14_1_0 (bvadd accu_14_1 #x0001) (ite exec_14_1_2 (ite (and sb-full_14_1 (= sb-adr_14_1 #x0000)) sb-val_14_1 (select heap_14 #x0000)) accu_14_1))))
(assert (= accu_15_2 (ite exec_14_2_1 (bvadd accu_14_2 (ite (and sb-full_14_2 (= sb-adr_14_2 #x0000)) sb-val_14_2 (select heap_14 #x0000))) (ite exec_14_2_2 (bvadd accu_14_2 (ite (and sb-full_14_2 (= sb-adr_14_2 #x0001)) sb-val_14_2 (select heap_14 #x0001))) accu_14_2))))

; mem variables - mem_<step>_<thread>
(assert (= mem_15_0 mem_14_0))
(assert (= mem_15_1 mem_14_1))
(assert (= mem_15_2 mem_14_2))

; store buffer address variables - sb-adr_<step>_<thread>
(assert (= sb-adr_15_0 (ite exec_14_0_1 #x0000 sb-adr_14_0)))
(assert (= sb-adr_15_1 (ite exec_14_1_1 #x0001 sb-adr_14_1)))
(assert (= sb-adr_15_2 sb-adr_14_2))

; store buffer value variables - sb-val_<step>_<thread>
(assert (= sb-val_15_0 (ite exec_14_0_1 accu_14_0 sb-val_14_0)))
(assert (= sb-val_15_1 (ite exec_14_1_1 accu_14_1 sb-val_14_1)))
(assert (= sb-val_15_2 sb-val_14_2))

; store buffer full variables - sb-full_<step>_<thread>
(assert (= sb-full_15_0 (ite flush_14_0 false (or exec_14_0_1 sb-full_14_0))))
(assert (= sb-full_15_1 (ite flush_14_1 false (or exec_14_1_1 sb-full_14_1))))
(assert (= sb-full_15_2 (ite flush_14_2 false sb-full_14_2)))
...
(assert (= stmt_15_2_0 (and stmt_14_2_0 (not exec_14_2_0))))
(assert (= stmt_15_2_1 (ite stmt_14_2_0 exec_14_2_0 (and stmt_14_2_1 (not exec_14_2_1)))))
(assert (= stmt_15_2_2 (ite stmt_14_2_1 exec_14_2_1 (and stmt_14_2_2 (not exec_14_2_2)))))
(assert (= stmt_15_2_3 (ite stmt_14_2_2 exec_14_2_2 (and stmt_14_2_3 (not exec_14_2_3)))))
(assert (= stmt_15_2_4 (ite stmt_14_2_3 (and exec_14_2_3 (not (= accu_14_2 #x0000))) (and stmt_14_2_4 (not exec_14_2_4)))))
(assert (= stmt_15_2_5 (ite stmt_14_2_3 (and exec_14_2_3 (= accu_14_2 #x0000)) (and stmt_14_2_5 (not exec_14_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_15_0_0 (ite check_14_0 false (or exec_14_0_3 block_14_0_0))))
(assert (= block_15_0_1 (ite check_14_0 false (or exec_14_1_3 block_14_0_1))))
(assert (= block_15_0_2 (ite check_14_0 false (or exec_14_2_0 block_14_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_16_0 (ite exec_15_0_0 (bvadd accu_15_0 #x0001) (ite exec_15_0_2 (ite (and sb-full_15_0 (= sb-adr_15_0 #x0001)) sb-val_15_0 (select heap_15 #x0001)) accu_15_0))))
(assert (= accu_16_1 (ite exec_15_1_0 (bvadd accu_15_1 #x0001) (ite exec_15_1_2 (ite (and sb-full_15_1 (= sb-adr_15_1 #x0000)) sb-val_15_1 (select heap_15 #x0000)) accu_15_1))))
(assert (= accu_16_2 (ite exec_15_2_1 (bvadd accu_15_2 (ite (and sb-full_15_2 (= sb-adr_15_2 #x0000)) sb-val_15_2 (select heap_15 #x0000))) (ite exec_15_2_2 (bvadd accu_15_2 (ite (and sb-full_15_2 (= sb-adr_15_2 #x0001)) sb-val_15_2 (select heap_15 #x0001))) accu_15_2))))

; mem variables - mem_<step>_<thread>
(assert (= mem_16_0 mem_15_0))
(assert (= mem_16_1 mem_15_1))
(assert (= mem_16_2 mem_15_2))

; store buffer address variables - sb-adr_<step>_<thread>
(assert (= sb-adr_16_0 (ite exec_15_0_1 #x0000 sb-adr_15_0)))
(assert (= sb-adr_16_1 (ite exec_15_1_1 #x0001 sb-adr_15_1)))
(assert (= sb-adr_16_2 sb-adr_15_2))

; store buffer value variables - sb-val_<step>_<thread>
(assert (= sb-val_16_0 (ite exec_15_0_1 accu_15_0 sb-val_15_0)))
(assert (= sb-val_16_1 (ite exec_15_1_1 accu_15_1 sb-val_15_1)))
(assert (= sb-val_16_2 sb-val_15_2))

; store buffer full variables - sb-full_<step>_<thread>
(assert (= sb-full_16_0 (ite flush_15_0 false (or exec_15_0_1 sb-full_15_0))))
(assert (= sb-full_16_1 (ite flush_15_1 false (or exec_15_1_1 sb-full_15_1))))
(assert (= sb-full_16_2 (ite flush_15_2 false sb-full_15_2)))
...
(assert (= stmt_16_2_0 (and stmt_15_2_0 (not exec_15_2_0))))
(assert (= stmt_16_2_1 (ite stmt_15_2_0 exec_15_2_0 (and stmt_15_2_1 (not exec_15_2_1)))))
(assert (= stmt_16_2_2 (ite stmt_15_2_1 exec_15_2_1 (and stmt_15_2_2 (not exec_15_2_2)))))
(assert (= stmt_16_2_3 (ite stmt_15_2_2 exec_15_2_2 (and stmt_15_2_3 (not exec_15_2_3)))))
(assert (= stmt_16_2_4 (ite stmt_15_2_3 (and exec_15_2_3 (not (= accu_15_2 #x0000))) (and stmt_15_2_4 (not exec_15_2_4)))))
(assert (= stmt_16_2_5 (ite stmt_15_2_3 (and exec_15_2_3 (= accu_15_2 #x0000)) (and stmt_15_2_5 (not exec_15_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_16_0_0 (ite check_15_0 false (or exec_15_0_3 block_15_0_0))))
(assert (= block_16_0_1 (ite check_15_0 false (or exec_15_1_3 block_15_0_1))))
(assert (= block_16_0_2 (ite check_15_0 false (or exec_15_2_0 block_15_0_2))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_17_0 (ite exec_16_0_0 (bvadd accu_16_0 #x0001) (ite exec_16_0_2 (ite (and sb-full_16_0 (= sb-adr_16_0 #x0001)) sb-val_16_0 (select heap_16 #x0001)) accu_16_0))))
(assert (= accu_17_1 (ite exec_16_1_0 (bvadd accu_16_1 #x0001) (ite exec_16_1_2 (ite (and sb-full_16_1 (= sb-adr_16_1 #x0000)) sb-val_16_1 (select heap_16 #x0000)) accu_16_1))))
(assert (= accu_17_2 (ite exec_16_2_1 (bvadd accu_16_2 (ite (and sb-full_16_2 (= sb-adr_16_2 #x0000)) sb-val_16_2 (select heap_16 #x0000))) (ite exec_16_2_2 (bvadd accu_16_2 (ite (and sb-full_16_2 (= sb-adr_16_2 #x0001)) sb-val_16_2 (select heap_16 #x0001))) accu_16_2))))

; mem variables - mem_<step>_<thread>
(assert (= mem_17_0 mem_16_0))
(assert (= mem_17_1 mem_16_1))
(assert (= mem_17_2 mem_16_2))

; store buffer address variables - sb-adr_<step>_<thread>
(assert (= sb-adr_17_0 (ite exec_16_0_1 #x0000 sb-adr_16_0)))
(assert (= sb-adr_17_1 (ite exec_16_1_1 #x0001 sb-adr_16_1)))
(assert (= sb-adr_17_2 sb-adr_16_2))

; store buffer value variables - sb-val_<step>_<thread>
(assert (= sb-val_17_0 (ite exec_16_0_1 accu_16_0 sb-val_16_0)))
(assert (= sb-val_17_1 (ite exec_16_1_1 accu_16_1 sb-val_16_1)))
(assert (= sb-val_17_2 sb-val_16_2))

; store buffer full variables - sb-full_<step>_<thread>
(assert (= sb-full_17_0 (ite flush_16_0 false (or exec_16_0_1 sb-full_16_0))))
(assert (= sb-full_17_1 (ite flush_16_1 false (or exec_16_1_1 sb-full_16_1))))
(assert (= sb-full_17_2 (ite flush_16_2 false sb-full_16_2)))

; statement activation variables - stmt_<step>_<thread>_<pc>
(assert (= stmt_17_0_0 (and stmt_16_0_0 (not exec_16_0_0))))
(assert (= stmt_17_0_1 (ite stmt_16_0_0 exec_16_0_0 (and stmt_16_0_1 (not exec_16_0_1)))))
(assert (= stmt_17_0_2 (ite stmt_16_0_1 exec_16_0_1 (and stmt_16_0_2 (not exec_16_0_2)))))
(assert (= stmt_17_0_3 (ite stmt_16_0_2 exec_16_0_2 (and stmt_16_0_3 (not exec_16_0_3)))))
(assert (= stmt_17_0_4 (ite stmt_16_0_3 exec_16_0_3 (and stmt_16_0_4 (not exec_16_0_4)))))

(assert (= stmt_17_1_0 (and stmt_16_1_0 (not exec_16_1_0))))
(assert (= stmt_17_1_1 (ite stmt_16_1_0 exec_16_1_0 (and stmt_16_1_1 (not exec_16_1_1)))))
(assert (= stmt_17_1_2 (ite stmt_16_1_1 exec_16_1_1 (and stmt_16_1_2 (not exec_16_1_2)))))
(assert (= stmt_17_1_3 (ite stmt_16_1_2 exec_16_1_2 (and stmt_16_1_3 (not exec_16_1_3)))))
(assert (= stmt_17_1_4 (ite stmt_16_1_3 exec_16_1_3 (and stmt_16_1_4 (not exec_16_1_4)))))

(assert (= stmt_17_2_0 (and stmt_16_2_0 (not exec_16_2_0))))
(assert (= stmt_17_2_1 (ite stmt_16_2_0 exec_16_2_0 (and stmt_16_2_1 (not exec_16_2_1)))))
(assert (= stmt_17_2_2 (ite stmt_16_2_1 exec_16_2_1 (and stmt_16_2_2 (not exec_16_2_2)))))
(assert (= stmt_17_2_3 (ite stmt_16_2_2 exec_16_2_2 (and stmt_16_2_3 (not exec_16_2_3)))))
(assert (= stmt_17_2_4 (ite stmt_16_2_3 (and exec_16_2_3 (not (= accu_16_2 #x0000))) (and stmt_16_2_4 (not exec_16_2_4)))))
(assert (= stmt_17_2_5 (ite stmt_16_2_3 (and exec_16_2_3 (= accu_16_2 #x0000)) (and stmt_16_2_5 (not exec_16_2_5)))))

; blocking variables - block_<step>_<id>_<thread>
(assert (= block_17_0_0 (ite check_16_0 false (or exec_16_0_3 block_16_0_0))))
(assert (= block_17_0_1 (ite check_16_0 false (or exec_16_1_3 block_16_0_1))))
(assert (= block_17_0_2 (ite check_16_0 false (or exec_16_2_0 block_16_0_2))))
