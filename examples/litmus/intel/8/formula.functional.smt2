...
; accu variables - accu_<step>_<thread>
(assert (= accu_1_0 (ite exec_0_0_0 (bvadd accu_0_0 #x0001) (ite exec_0_0_1 (ite (= mem_0_0 (select heap_0 #x0000)) #x0001 #x0000) accu_0_0))))
(assert (= accu_1_1 (ite exec_0_1_0 (bvadd accu_0_1 #x0001) (ite exec_0_1_1 (ite (= mem_0_1 (select heap_0 #x0001)) #x0001 #x0000) accu_0_1))))
...
; heap variable - heap_<step>
(assert (= heap_1 (ite flush_0_0 (store heap_0 sb-adr_0_0 sb-val_0_0) (ite exec_0_0_1 (ite (= mem_0_0 (select heap_0 #x0000)) (store heap_0 #x0000 accu_0_0) heap_0) (ite flush_0_1 (store heap_0 sb-adr_0_1 sb-val_0_1) (ite exec_0_1_1 (ite (= mem_0_1 (select heap_0 #x0001)) (store heap_0 #x0001 accu_0_1) heap_0) (ite flush_0_2 (store heap_0 sb-adr_0_2 sb-val_0_2) (ite flush_0_3 (store heap_0 sb-adr_0_3 sb-val_0_3) heap_0))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_2_0 (ite exec_1_0_0 (bvadd accu_1_0 #x0001) (ite exec_1_0_1 (ite (= mem_1_0 (select heap_1 #x0000)) #x0001 #x0000) accu_1_0))))
(assert (= accu_2_1 (ite exec_1_1_0 (bvadd accu_1_1 #x0001) (ite exec_1_1_1 (ite (= mem_1_1 (select heap_1 #x0001)) #x0001 #x0000) accu_1_1))))
...
; heap variable - heap_<step>
(assert (= heap_2 (ite flush_1_0 (store heap_1 sb-adr_1_0 sb-val_1_0) (ite exec_1_0_1 (ite (= mem_1_0 (select heap_1 #x0000)) (store heap_1 #x0000 accu_1_0) heap_1) (ite flush_1_1 (store heap_1 sb-adr_1_1 sb-val_1_1) (ite exec_1_1_1 (ite (= mem_1_1 (select heap_1 #x0001)) (store heap_1 #x0001 accu_1_1) heap_1) (ite flush_1_2 (store heap_1 sb-adr_1_2 sb-val_1_2) (ite flush_1_3 (store heap_1 sb-adr_1_3 sb-val_1_3) heap_1))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_3_0 (ite exec_2_0_0 (bvadd accu_2_0 #x0001) (ite exec_2_0_1 (ite (= mem_2_0 (select heap_2 #x0000)) #x0001 #x0000) accu_2_0))))
(assert (= accu_3_1 (ite exec_2_1_0 (bvadd accu_2_1 #x0001) (ite exec_2_1_1 (ite (= mem_2_1 (select heap_2 #x0001)) #x0001 #x0000) accu_2_1))))
...
; heap variable - heap_<step>
(assert (= heap_3 (ite flush_2_0 (store heap_2 sb-adr_2_0 sb-val_2_0) (ite exec_2_0_1 (ite (= mem_2_0 (select heap_2 #x0000)) (store heap_2 #x0000 accu_2_0) heap_2) (ite flush_2_1 (store heap_2 sb-adr_2_1 sb-val_2_1) (ite exec_2_1_1 (ite (= mem_2_1 (select heap_2 #x0001)) (store heap_2 #x0001 accu_2_1) heap_2) (ite flush_2_2 (store heap_2 sb-adr_2_2 sb-val_2_2) (ite flush_2_3 (store heap_2 sb-adr_2_3 sb-val_2_3) heap_2))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_4_0 (ite exec_3_0_0 (bvadd accu_3_0 #x0001) (ite exec_3_0_1 (ite (= mem_3_0 (select heap_3 #x0000)) #x0001 #x0000) accu_3_0))))
(assert (= accu_4_1 (ite exec_3_1_0 (bvadd accu_3_1 #x0001) (ite exec_3_1_1 (ite (= mem_3_1 (select heap_3 #x0001)) #x0001 #x0000) accu_3_1))))
...
; heap variable - heap_<step>
(assert (= heap_4 (ite flush_3_0 (store heap_3 sb-adr_3_0 sb-val_3_0) (ite exec_3_0_1 (ite (= mem_3_0 (select heap_3 #x0000)) (store heap_3 #x0000 accu_3_0) heap_3) (ite flush_3_1 (store heap_3 sb-adr_3_1 sb-val_3_1) (ite exec_3_1_1 (ite (= mem_3_1 (select heap_3 #x0001)) (store heap_3 #x0001 accu_3_1) heap_3) (ite flush_3_2 (store heap_3 sb-adr_3_2 sb-val_3_2) (ite flush_3_3 (store heap_3 sb-adr_3_3 sb-val_3_3) heap_3))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_5_0 (ite exec_4_0_0 (bvadd accu_4_0 #x0001) (ite exec_4_0_1 (ite (= mem_4_0 (select heap_4 #x0000)) #x0001 #x0000) accu_4_0))))
(assert (= accu_5_1 (ite exec_4_1_0 (bvadd accu_4_1 #x0001) (ite exec_4_1_1 (ite (= mem_4_1 (select heap_4 #x0001)) #x0001 #x0000) accu_4_1))))
...
; heap variable - heap_<step>
(assert (= heap_5 (ite flush_4_0 (store heap_4 sb-adr_4_0 sb-val_4_0) (ite exec_4_0_1 (ite (= mem_4_0 (select heap_4 #x0000)) (store heap_4 #x0000 accu_4_0) heap_4) (ite flush_4_1 (store heap_4 sb-adr_4_1 sb-val_4_1) (ite exec_4_1_1 (ite (= mem_4_1 (select heap_4 #x0001)) (store heap_4 #x0001 accu_4_1) heap_4) (ite flush_4_2 (store heap_4 sb-adr_4_2 sb-val_4_2) (ite flush_4_3 (store heap_4 sb-adr_4_3 sb-val_4_3) heap_4))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_6_0 (ite exec_5_0_0 (bvadd accu_5_0 #x0001) (ite exec_5_0_1 (ite (= mem_5_0 (select heap_5 #x0000)) #x0001 #x0000) accu_5_0))))
(assert (= accu_6_1 (ite exec_5_1_0 (bvadd accu_5_1 #x0001) (ite exec_5_1_1 (ite (= mem_5_1 (select heap_5 #x0001)) #x0001 #x0000) accu_5_1))))
...
; heap variable - heap_<step>
(assert (= heap_6 (ite flush_5_0 (store heap_5 sb-adr_5_0 sb-val_5_0) (ite exec_5_0_1 (ite (= mem_5_0 (select heap_5 #x0000)) (store heap_5 #x0000 accu_5_0) heap_5) (ite flush_5_1 (store heap_5 sb-adr_5_1 sb-val_5_1) (ite exec_5_1_1 (ite (= mem_5_1 (select heap_5 #x0001)) (store heap_5 #x0001 accu_5_1) heap_5) (ite flush_5_2 (store heap_5 sb-adr_5_2 sb-val_5_2) (ite flush_5_3 (store heap_5 sb-adr_5_3 sb-val_5_3) heap_5))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_7_0 (ite exec_6_0_0 (bvadd accu_6_0 #x0001) (ite exec_6_0_1 (ite (= mem_6_0 (select heap_6 #x0000)) #x0001 #x0000) accu_6_0))))
(assert (= accu_7_1 (ite exec_6_1_0 (bvadd accu_6_1 #x0001) (ite exec_6_1_1 (ite (= mem_6_1 (select heap_6 #x0001)) #x0001 #x0000) accu_6_1))))
...
; heap variable - heap_<step>
(assert (= heap_7 (ite flush_6_0 (store heap_6 sb-adr_6_0 sb-val_6_0) (ite exec_6_0_1 (ite (= mem_6_0 (select heap_6 #x0000)) (store heap_6 #x0000 accu_6_0) heap_6) (ite flush_6_1 (store heap_6 sb-adr_6_1 sb-val_6_1) (ite exec_6_1_1 (ite (= mem_6_1 (select heap_6 #x0001)) (store heap_6 #x0001 accu_6_1) heap_6) (ite flush_6_2 (store heap_6 sb-adr_6_2 sb-val_6_2) (ite flush_6_3 (store heap_6 sb-adr_6_3 sb-val_6_3) heap_6))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_8_0 (ite exec_7_0_0 (bvadd accu_7_0 #x0001) (ite exec_7_0_1 (ite (= mem_7_0 (select heap_7 #x0000)) #x0001 #x0000) accu_7_0))))
(assert (= accu_8_1 (ite exec_7_1_0 (bvadd accu_7_1 #x0001) (ite exec_7_1_1 (ite (= mem_7_1 (select heap_7 #x0001)) #x0001 #x0000) accu_7_1))))
...
; heap variable - heap_<step>
(assert (= heap_8 (ite flush_7_0 (store heap_7 sb-adr_7_0 sb-val_7_0) (ite exec_7_0_1 (ite (= mem_7_0 (select heap_7 #x0000)) (store heap_7 #x0000 accu_7_0) heap_7) (ite flush_7_1 (store heap_7 sb-adr_7_1 sb-val_7_1) (ite exec_7_1_1 (ite (= mem_7_1 (select heap_7 #x0001)) (store heap_7 #x0001 accu_7_1) heap_7) (ite flush_7_2 (store heap_7 sb-adr_7_2 sb-val_7_2) (ite flush_7_3 (store heap_7 sb-adr_7_3 sb-val_7_3) heap_7))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_9_0 (ite exec_8_0_0 (bvadd accu_8_0 #x0001) (ite exec_8_0_1 (ite (= mem_8_0 (select heap_8 #x0000)) #x0001 #x0000) accu_8_0))))
(assert (= accu_9_1 (ite exec_8_1_0 (bvadd accu_8_1 #x0001) (ite exec_8_1_1 (ite (= mem_8_1 (select heap_8 #x0001)) #x0001 #x0000) accu_8_1))))
...
; store buffer address variables - sb-adr_<step>_<thread>
(assert (= sb-adr_9_0 sb-adr_8_0))
(assert (= sb-adr_9_1 sb-adr_8_1))
(assert (= sb-adr_9_2 sb-adr_8_2))
(assert (= sb-adr_9_3 sb-adr_8_3))

; store buffer value variables - sb-val_<step>_<thread>
(assert (= sb-val_9_0 sb-val_8_0))
(assert (= sb-val_9_1 sb-val_8_1))
(assert (= sb-val_9_2 sb-val_8_2))
(assert (= sb-val_9_3 sb-val_8_3))

; store buffer full variables - sb-full_<step>_<thread>
(assert (= sb-full_9_0 (ite flush_8_0 false sb-full_8_0)))
(assert (= sb-full_9_1 (ite flush_8_1 false sb-full_8_1)))
...
; heap variable - heap_<step>
(assert (= heap_9 (ite flush_8_0 (store heap_8 sb-adr_8_0 sb-val_8_0) (ite exec_8_0_1 (ite (= mem_8_0 (select heap_8 #x0000)) (store heap_8 #x0000 accu_8_0) heap_8) (ite flush_8_1 (store heap_8 sb-adr_8_1 sb-val_8_1) (ite exec_8_1_1 (ite (= mem_8_1 (select heap_8 #x0001)) (store heap_8 #x0001 accu_8_1) heap_8) (ite flush_8_2 (store heap_8 sb-adr_8_2 sb-val_8_2) (ite flush_8_3 (store heap_8 sb-adr_8_3 sb-val_8_3) heap_8))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_10_0 (ite exec_9_0_0 (bvadd accu_9_0 #x0001) (ite exec_9_0_1 (ite (= mem_9_0 (select heap_9 #x0000)) #x0001 #x0000) accu_9_0))))
(assert (= accu_10_1 (ite exec_9_1_0 (bvadd accu_9_1 #x0001) (ite exec_9_1_1 (ite (= mem_9_1 (select heap_9 #x0001)) #x0001 #x0000) accu_9_1))))
...
; store buffer address variables - sb-adr_<step>_<thread>
(assert (= sb-adr_10_0 sb-adr_9_0))
(assert (= sb-adr_10_1 sb-adr_9_1))
(assert (= sb-adr_10_2 sb-adr_9_2))
(assert (= sb-adr_10_3 sb-adr_9_3))

; store buffer value variables - sb-val_<step>_<thread>
(assert (= sb-val_10_0 sb-val_9_0))
(assert (= sb-val_10_1 sb-val_9_1))
(assert (= sb-val_10_2 sb-val_9_2))
(assert (= sb-val_10_3 sb-val_9_3))

; store buffer full variables - sb-full_<step>_<thread>
(assert (= sb-full_10_0 (ite flush_9_0 false sb-full_9_0)))
(assert (= sb-full_10_1 (ite flush_9_1 false sb-full_9_1)))
...
; heap variable - heap_<step>
(assert (= heap_10 (ite flush_9_0 (store heap_9 sb-adr_9_0 sb-val_9_0) (ite exec_9_0_1 (ite (= mem_9_0 (select heap_9 #x0000)) (store heap_9 #x0000 accu_9_0) heap_9) (ite flush_9_1 (store heap_9 sb-adr_9_1 sb-val_9_1) (ite exec_9_1_1 (ite (= mem_9_1 (select heap_9 #x0001)) (store heap_9 #x0001 accu_9_1) heap_9) (ite flush_9_2 (store heap_9 sb-adr_9_2 sb-val_9_2) (ite flush_9_3 (store heap_9 sb-adr_9_3 sb-val_9_3) heap_9))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_11_0 (ite exec_10_0_0 (bvadd accu_10_0 #x0001) (ite exec_10_0_1 (ite (= mem_10_0 (select heap_10 #x0000)) #x0001 #x0000) accu_10_0))))
(assert (= accu_11_1 (ite exec_10_1_0 (bvadd accu_10_1 #x0001) (ite exec_10_1_1 (ite (= mem_10_1 (select heap_10 #x0001)) #x0001 #x0000) accu_10_1))))
...
; store buffer address variables - sb-adr_<step>_<thread>
(assert (= sb-adr_11_0 sb-adr_10_0))
(assert (= sb-adr_11_1 sb-adr_10_1))
(assert (= sb-adr_11_2 sb-adr_10_2))
(assert (= sb-adr_11_3 sb-adr_10_3))

; store buffer value variables - sb-val_<step>_<thread>
(assert (= sb-val_11_0 sb-val_10_0))
(assert (= sb-val_11_1 sb-val_10_1))
(assert (= sb-val_11_2 sb-val_10_2))
(assert (= sb-val_11_3 sb-val_10_3))

; store buffer full variables - sb-full_<step>_<thread>
(assert (= sb-full_11_0 (ite flush_10_0 false sb-full_10_0)))
(assert (= sb-full_11_1 (ite flush_10_1 false sb-full_10_1)))
...
; heap variable - heap_<step>
(assert (= heap_11 (ite flush_10_0 (store heap_10 sb-adr_10_0 sb-val_10_0) (ite exec_10_0_1 (ite (= mem_10_0 (select heap_10 #x0000)) (store heap_10 #x0000 accu_10_0) heap_10) (ite flush_10_1 (store heap_10 sb-adr_10_1 sb-val_10_1) (ite exec_10_1_1 (ite (= mem_10_1 (select heap_10 #x0001)) (store heap_10 #x0001 accu_10_1) heap_10) (ite flush_10_2 (store heap_10 sb-adr_10_2 sb-val_10_2) (ite flush_10_3 (store heap_10 sb-adr_10_3 sb-val_10_3) heap_10))))))))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_12_0 (ite exec_11_0_0 (bvadd accu_11_0 #x0001) (ite exec_11_0_1 (ite (= mem_11_0 (select heap_11 #x0000)) #x0001 #x0000) accu_11_0))))
(assert (= accu_12_1 (ite exec_11_1_0 (bvadd accu_11_1 #x0001) (ite exec_11_1_1 (ite (= mem_11_1 (select heap_11 #x0001)) #x0001 #x0000) accu_11_1))))
...
; store buffer address variables - sb-adr_<step>_<thread>
(assert (= sb-adr_12_0 sb-adr_11_0))
(assert (= sb-adr_12_1 sb-adr_11_1))
(assert (= sb-adr_12_2 sb-adr_11_2))
(assert (= sb-adr_12_3 sb-adr_11_3))

; store buffer value variables - sb-val_<step>_<thread>
(assert (= sb-val_12_0 sb-val_11_0))
(assert (= sb-val_12_1 sb-val_11_1))
(assert (= sb-val_12_2 sb-val_11_2))
(assert (= sb-val_12_3 sb-val_11_3))

; store buffer full variables - sb-full_<step>_<thread>
(assert (= sb-full_12_0 (ite flush_11_0 false sb-full_11_0)))
(assert (= sb-full_12_1 (ite flush_11_1 false sb-full_11_1)))
...
; heap variable - heap_<step>
(assert (= heap_12 (ite flush_11_0 (store heap_11 sb-adr_11_0 sb-val_11_0) (ite exec_11_0_1 (ite (= mem_11_0 (select heap_11 #x0000)) (store heap_11 #x0000 accu_11_0) heap_11) (ite flush_11_1 (store heap_11 sb-adr_11_1 sb-val_11_1) (ite exec_11_1_1 (ite (= mem_11_1 (select heap_11 #x0001)) (store heap_11 #x0001 accu_11_1) heap_11) (ite flush_11_2 (store heap_11 sb-adr_11_2 sb-val_11_2) (ite flush_11_3 (store heap_11 sb-adr_11_3 sb-val_11_3) heap_11))))))))
