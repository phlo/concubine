...
(assert (=> exec_0_0_1 (and (= accu_1_0 (ite (= mem_0_0 (select heap_0 #x0000)) #x0001 #x0000)) (= mem_1_0 mem_0_0) (= sb-adr_1_0 sb-adr_0_0) (= sb-val_1_0 sb-val_0_0) (= sb-full_1_0 sb-full_0_0) (and (not stmt_1_0_0) (not stmt_1_0_1) stmt_1_0_2) (= halt_1_0 halt_0_0) (= heap_1 (ite (= mem_0_0 (select heap_0 #x0000)) (store heap_0 #x0000 accu_0_0) heap_0)) (not exit_1))))
...
(assert (=> flush_0_3 (and (= heap_1 (store heap_0 sb-adr_0_3 sb-val_0_3)) (not exit_1))))
...
(assert (=> exec_1_0_1 (and (= accu_2_0 (ite (= mem_1_0 (select heap_1 #x0000)) #x0001 #x0000)) (= mem_2_0 mem_1_0) (= sb-adr_2_0 sb-adr_1_0) (= sb-val_2_0 sb-val_1_0) (= sb-full_2_0 sb-full_1_0) (and (not stmt_2_0_0) (not stmt_2_0_1) stmt_2_0_2) (= halt_2_0 halt_1_0) (= heap_2 (ite (= mem_1_0 (select heap_1 #x0000)) (store heap_1 #x0000 accu_1_0) heap_1)) (not exit_2))))
...
(assert (=> exec_1_1_1 (and (= accu_2_1 (ite (= mem_1_1 (select heap_1 #x0001)) #x0001 #x0000)) (= mem_2_1 mem_1_1) (= sb-adr_2_1 sb-adr_1_1) (= sb-val_2_1 sb-val_1_1) (= sb-full_2_1 sb-full_1_1) (and (not stmt_2_1_0) (not stmt_2_1_1) stmt_2_1_2) (= halt_2_1 halt_1_1) (= heap_2 (ite (= mem_1_1 (select heap_1 #x0001)) (store heap_1 #x0001 accu_1_1) heap_1)) (not exit_2))))
...
(assert (=> flush_1_3 (and (= heap_2 (store heap_1 sb-adr_1_3 sb-val_1_3)) (not exit_2))))
...
(assert (=> exec_2_0_1 (and (= accu_3_0 (ite (= mem_2_0 (select heap_2 #x0000)) #x0001 #x0000)) (= mem_3_0 mem_2_0) (= sb-adr_3_0 sb-adr_2_0) (= sb-val_3_0 sb-val_2_0) (= sb-full_3_0 sb-full_2_0) (and (not stmt_3_0_0) (not stmt_3_0_1) stmt_3_0_2) (= halt_3_0 halt_2_0) (= heap_3 (ite (= mem_2_0 (select heap_2 #x0000)) (store heap_2 #x0000 accu_2_0) heap_2)) (not exit_3))))
...
(assert (=> flush_2_3 (and (= heap_3 (store heap_2 sb-adr_2_3 sb-val_2_3)) (not exit_3))))
...
(assert (=> exec_3_0_1 (and (= accu_4_0 (ite (= mem_3_0 (select heap_3 #x0000)) #x0001 #x0000)) (= mem_4_0 mem_3_0) (= sb-adr_4_0 sb-adr_3_0) (= sb-val_4_0 sb-val_3_0) (= sb-full_4_0 sb-full_3_0) (and (not stmt_4_0_0) (not stmt_4_0_1) stmt_4_0_2) (= halt_4_0 halt_3_0) (= heap_4 (ite (= mem_3_0 (select heap_3 #x0000)) (store heap_3 #x0000 accu_3_0) heap_3)) (not exit_4))))
...
(assert (=> flush_3_3 (and (= heap_4 (store heap_3 sb-adr_3_3 sb-val_3_3)) (not exit_4))))
...
(assert (=> exec_4_0_1 (and (= accu_5_0 (ite (= mem_4_0 (select heap_4 #x0000)) #x0001 #x0000)) (= mem_5_0 mem_4_0) (= sb-adr_5_0 sb-adr_4_0) (= sb-val_5_0 sb-val_4_0) (= sb-full_5_0 sb-full_4_0) (and (not stmt_5_0_0) (not stmt_5_0_1) stmt_5_0_2) (= halt_5_0 halt_4_0) (= heap_5 (ite (= mem_4_0 (select heap_4 #x0000)) (store heap_4 #x0000 accu_4_0) heap_4)) (not exit_5))))
...
(assert (=> exec_4_1_1 (and (= accu_5_1 (ite (= mem_4_1 (select heap_4 #x0001)) #x0001 #x0000)) (= mem_5_1 mem_4_1) (= sb-adr_5_1 sb-adr_4_1) (= sb-val_5_1 sb-val_4_1) (= sb-full_5_1 sb-full_4_1) (and (not stmt_5_1_0) (not stmt_5_1_1) stmt_5_1_2) (= halt_5_1 halt_4_1) (= heap_5 (ite (= mem_4_1 (select heap_4 #x0001)) (store heap_4 #x0001 accu_4_1) heap_4)) (not exit_5))))
...
(assert (=> flush_4_3 (and (= heap_5 (store heap_4 sb-adr_4_3 sb-val_4_3)) (not exit_5))))
...
(assert (=> exec_5_0_1 (and (= accu_6_0 (ite (= mem_5_0 (select heap_5 #x0000)) #x0001 #x0000)) (= mem_6_0 mem_5_0) (= sb-adr_6_0 sb-adr_5_0) (= sb-val_6_0 sb-val_5_0) (= sb-full_6_0 sb-full_5_0) (and (not stmt_6_0_0) (not stmt_6_0_1) stmt_6_0_2) (= halt_6_0 halt_5_0) (= heap_6 (ite (= mem_5_0 (select heap_5 #x0000)) (store heap_5 #x0000 accu_5_0) heap_5)) (not exit_6))))
...
(assert (=> exec_5_1_1 (and (= accu_6_1 (ite (= mem_5_1 (select heap_5 #x0001)) #x0001 #x0000)) (= mem_6_1 mem_5_1) (= sb-adr_6_1 sb-adr_5_1) (= sb-val_6_1 sb-val_5_1) (= sb-full_6_1 sb-full_5_1) (and (not stmt_6_1_0) (not stmt_6_1_1) stmt_6_1_2) (= halt_6_1 halt_5_1) (= heap_6 (ite (= mem_5_1 (select heap_5 #x0001)) (store heap_5 #x0001 accu_5_1) heap_5)) (not exit_6))))
...
(assert (=> flush_5_3 (and (= heap_6 (store heap_5 sb-adr_5_3 sb-val_5_3)) (not exit_6))))
...
(assert (=> exec_6_0_1 (and (= accu_7_0 (ite (= mem_6_0 (select heap_6 #x0000)) #x0001 #x0000)) (= mem_7_0 mem_6_0) (= sb-adr_7_0 sb-adr_6_0) (= sb-val_7_0 sb-val_6_0) (= sb-full_7_0 sb-full_6_0) (and (not stmt_7_0_0) (not stmt_7_0_1) stmt_7_0_2) (= halt_7_0 halt_6_0) (= heap_7 (ite (= mem_6_0 (select heap_6 #x0000)) (store heap_6 #x0000 accu_6_0) heap_6)) (not exit_7))))
...
(assert (=> flush_6_3 (and (= heap_7 (store heap_6 sb-adr_6_3 sb-val_6_3)) (not exit_7))))
...
(assert (=> exec_7_0_1 (and (= accu_8_0 (ite (= mem_7_0 (select heap_7 #x0000)) #x0001 #x0000)) (= mem_8_0 mem_7_0) (= sb-adr_8_0 sb-adr_7_0) (= sb-val_8_0 sb-val_7_0) (= sb-full_8_0 sb-full_7_0) (and (not stmt_8_0_0) (not stmt_8_0_1) stmt_8_0_2) (= halt_8_0 halt_7_0) (= heap_8 (ite (= mem_7_0 (select heap_7 #x0000)) (store heap_7 #x0000 accu_7_0) heap_7)) (not exit_8))))
...
(assert (=> flush_7_3 (and (= heap_8 (store heap_7 sb-adr_7_3 sb-val_7_3)) (not exit_8))))
...
(assert (=> exec_8_0_1 (and (= accu_9_0 (ite (= mem_8_0 (select heap_8 #x0000)) #x0001 #x0000)) (= mem_9_0 mem_8_0) (= sb-adr_9_0 sb-adr_8_0) (= sb-val_9_0 sb-val_8_0) (= sb-full_9_0 sb-full_8_0) (and (not stmt_9_0_0) (not stmt_9_0_1) stmt_9_0_2) (= halt_9_0 halt_8_0) (= heap_9 (ite (= mem_8_0 (select heap_8 #x0000)) (store heap_8 #x0000 accu_8_0) heap_8)) (not exit_9))))
...
(assert (=> exec_8_1_1 (and (= accu_9_1 (ite (= mem_8_1 (select heap_8 #x0001)) #x0001 #x0000)) (= mem_9_1 mem_8_1) (= sb-adr_9_1 sb-adr_8_1) (= sb-val_9_1 sb-val_8_1) (= sb-full_9_1 sb-full_8_1) (and (not stmt_9_1_0) (not stmt_9_1_1) stmt_9_1_2) (= halt_9_1 halt_8_1) (= heap_9 (ite (= mem_8_1 (select heap_8 #x0001)) (store heap_8 #x0001 accu_8_1) heap_8)) (not exit_9))))
...
(assert (=> flush_8_3 (and (= heap_9 (store heap_8 sb-adr_8_3 sb-val_8_3)) (not exit_9))))
...
(assert (=> exec_9_0_1 (and (= accu_10_0 (ite (= mem_9_0 (select heap_9 #x0000)) #x0001 #x0000)) (= mem_10_0 mem_9_0) (= sb-adr_10_0 sb-adr_9_0) (= sb-val_10_0 sb-val_9_0) (= sb-full_10_0 sb-full_9_0) (and (not stmt_10_0_0) (not stmt_10_0_1) stmt_10_0_2) (= halt_10_0 halt_9_0) (= heap_10 (ite (= mem_9_0 (select heap_9 #x0000)) (store heap_9 #x0000 accu_9_0) heap_9)) (not exit_10))))
...
(assert (=> exec_9_1_1 (and (= accu_10_1 (ite (= mem_9_1 (select heap_9 #x0001)) #x0001 #x0000)) (= mem_10_1 mem_9_1) (= sb-adr_10_1 sb-adr_9_1) (= sb-val_10_1 sb-val_9_1) (= sb-full_10_1 sb-full_9_1) (and (not stmt_10_1_0) (not stmt_10_1_1) stmt_10_1_2) (= halt_10_1 halt_9_1) (= heap_10 (ite (= mem_9_1 (select heap_9 #x0001)) (store heap_9 #x0001 accu_9_1) heap_9)) (not exit_10))))
...
(assert (=> flush_9_3 (and (= heap_10 (store heap_9 sb-adr_9_3 sb-val_9_3)) (not exit_10))))
...
(assert (=> exec_10_0_1 (and (= accu_11_0 (ite (= mem_10_0 (select heap_10 #x0000)) #x0001 #x0000)) (= mem_11_0 mem_10_0) (= sb-adr_11_0 sb-adr_10_0) (= sb-val_11_0 sb-val_10_0) (= sb-full_11_0 sb-full_10_0) (and (not stmt_11_0_0) (not stmt_11_0_1) stmt_11_0_2) (= halt_11_0 halt_10_0) (= heap_11 (ite (= mem_10_0 (select heap_10 #x0000)) (store heap_10 #x0000 accu_10_0) heap_10)) (not exit_11))))
...
(assert (=> exec_10_1_1 (and (= accu_11_1 (ite (= mem_10_1 (select heap_10 #x0001)) #x0001 #x0000)) (= mem_11_1 mem_10_1) (= sb-adr_11_1 sb-adr_10_1) (= sb-val_11_1 sb-val_10_1) (= sb-full_11_1 sb-full_10_1) (and (not stmt_11_1_0) (not stmt_11_1_1) stmt_11_1_2) (= halt_11_1 halt_10_1) (= heap_11 (ite (= mem_10_1 (select heap_10 #x0001)) (store heap_10 #x0001 accu_10_1) heap_10)) (not exit_11))))
...
(assert (=> flush_10_3 (and (= heap_11 (store heap_10 sb-adr_10_3 sb-val_10_3)) (not exit_11))))
...
(assert (=> exec_11_0_1 (and (= accu_12_0 (ite (= mem_11_0 (select heap_11 #x0000)) #x0001 #x0000)) (= mem_12_0 mem_11_0) (= sb-adr_12_0 sb-adr_11_0) (= sb-val_12_0 sb-val_11_0) (= sb-full_12_0 sb-full_11_0) (and (not stmt_12_0_0) (not stmt_12_0_1) stmt_12_0_2) (= halt_12_0 halt_11_0) (= heap_12 (ite (= mem_11_0 (select heap_11 #x0000)) (store heap_11 #x0000 accu_11_0) heap_11)) (not exit_12))))
...
(assert (=> exec_11_1_1 (and (= accu_12_1 (ite (= mem_11_1 (select heap_11 #x0001)) #x0001 #x0000)) (= mem_12_1 mem_11_1) (= sb-adr_12_1 sb-adr_11_1) (= sb-val_12_1 sb-val_11_1) (= sb-full_12_1 sb-full_11_1) (and (not stmt_12_1_0) (not stmt_12_1_1) stmt_12_1_2) (= halt_12_1 halt_11_1) (= heap_12 (ite (= mem_11_1 (select heap_11 #x0001)) (store heap_11 #x0001 accu_11_1) heap_11)) (not exit_12))))
...
(assert (=> flush_11_3 (and (= heap_12 (store heap_11 sb-adr_11_3 sb-val_11_3)) (not exit_12))))
