...
TEST_F(InstructionSetTest, Factory)
{
  ...
  ASSERT_STREQ("EXIT", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, STORE)
{
  ...
  ASSERT_STREQ("STORE", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, ADD)
{
  ...
  ASSERT_STREQ("ADD", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, ADDI)
{
  ...
  ASSERT_STREQ("ADDI", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, SUB)
{
  ...
  ASSERT_STREQ("SUB", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, SUBI)
{
  ...
  ASSERT_STREQ("SUBI", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, CMP)
{
  ...
  ASSERT_STREQ("CMP", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, JMP)
{
  ...
  ASSERT_STREQ("JMP", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, JZ)
{
  ...
  ASSERT_STREQ("JZ", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, JNZ)
{
  ...
  ASSERT_STREQ("JNZ", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, JS)
{
  ...
  ASSERT_STREQ("JS", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, JNS)
{
  ...
  ASSERT_STREQ("JNS", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, JNZNS)
{
  ...
  ASSERT_STREQ("JNZNS", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, MEM)
{
  ...
  ASSERT_STREQ("MEM", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, CAS)
{
  ...
  ASSERT_STREQ("CAS", instruction->getSymbol().c_str());
...
TEST_F(InstructionSetTest, SYNC)
{
  ...
  ASSERT_STREQ("SYNC", instruction->getSymbol().c_str());
