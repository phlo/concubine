...
(assert (= stmt_1_0_1 (ite stmt_0_0_0 (and exec_0_0_0 (not (not (= accu_0_0 #x0000)))) (and stmt_0_0_1 (not exec_0_0_1)))))
(assert (= stmt_1_0_2 (ite stmt_0_0_0 (and exec_0_0_0 (not (= accu_0_0 #x0000))) (and stmt_0_0_2 (not exec_0_0_2)))))

(assert (= stmt_1_1_0 (and stmt_0_1_0 (not exec_0_1_0))))
(assert (= stmt_1_1_1 (ite stmt_0_1_0 (and exec_0_1_0 (not (not (= accu_0_1 #x0000)))) (and stmt_0_1_1 (not exec_0_1_1)))))
(assert (= stmt_1_1_2 (ite stmt_0_1_0 (and exec_0_1_0 (not (= accu_0_1 #x0000))) (and stmt_0_1_2 (not exec_0_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_1_0 (or exec_0_0_1 halt_0_0)))
(assert (= halt_1_1 (or exec_0_1_1 halt_0_1)))

; heap variable - heap_<step>
(assert (= heap_1 (ite flush_0_0 (store heap_0 sb-adr_0_0 sb-val_0_0) (ite flush_0_1 (store heap_0 sb-adr_0_1 sb-val_0_1) heap_0))))

; exit flag variable - exit_<step>
(assert (= exit_1 (or exit_0 (and halt_1_0 halt_1_1) exec_0_0_2 exec_0_1_2)))
...
(assert (= stmt_2_0_1 (ite stmt_1_0_0 (and exec_1_0_0 (not (not (= accu_1_0 #x0000)))) (and stmt_1_0_1 (not exec_1_0_1)))))
(assert (= stmt_2_0_2 (ite stmt_1_0_0 (and exec_1_0_0 (not (= accu_1_0 #x0000))) (and stmt_1_0_2 (not exec_1_0_2)))))

(assert (= stmt_2_1_0 (and stmt_1_1_0 (not exec_1_1_0))))
(assert (= stmt_2_1_1 (ite stmt_1_1_0 (and exec_1_1_0 (not (not (= accu_1_1 #x0000)))) (and stmt_1_1_1 (not exec_1_1_1)))))
(assert (= stmt_2_1_2 (ite stmt_1_1_0 (and exec_1_1_0 (not (= accu_1_1 #x0000))) (and stmt_1_1_2 (not exec_1_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_2_0 (or exec_1_0_1 halt_1_0)))
(assert (= halt_2_1 (or exec_1_1_1 halt_1_1)))

; heap variable - heap_<step>
(assert (= heap_2 (ite flush_1_0 (store heap_1 sb-adr_1_0 sb-val_1_0) (ite flush_1_1 (store heap_1 sb-adr_1_1 sb-val_1_1) heap_1))))

; exit flag variable - exit_<step>
(assert (= exit_2 (or exit_1 (and halt_2_0 halt_2_1) exec_1_0_2 exec_1_1_2)))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_3_0 accu_2_0))
(assert (= accu_3_1 accu_2_1))
...
(assert (= stmt_3_0_1 (ite stmt_2_0_0 (and exec_2_0_0 (not (not (= accu_2_0 #x0000)))) (and stmt_2_0_1 (not exec_2_0_1)))))
(assert (= stmt_3_0_2 (ite stmt_2_0_0 (and exec_2_0_0 (not (= accu_2_0 #x0000))) (and stmt_2_0_2 (not exec_2_0_2)))))

(assert (= stmt_3_1_0 (and stmt_2_1_0 (not exec_2_1_0))))
(assert (= stmt_3_1_1 (ite stmt_2_1_0 (and exec_2_1_0 (not (not (= accu_2_1 #x0000)))) (and stmt_2_1_1 (not exec_2_1_1)))))
(assert (= stmt_3_1_2 (ite stmt_2_1_0 (and exec_2_1_0 (not (= accu_2_1 #x0000))) (and stmt_2_1_2 (not exec_2_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_3_0 (or exec_2_0_1 halt_2_0)))
(assert (= halt_3_1 (or exec_2_1_1 halt_2_1)))

; heap variable - heap_<step>
(assert (= heap_3 (ite flush_2_0 (store heap_2 sb-adr_2_0 sb-val_2_0) (ite flush_2_1 (store heap_2 sb-adr_2_1 sb-val_2_1) heap_2))))

; exit flag variable - exit_<step>
(assert (= exit_3 (or exit_2 (and halt_3_0 halt_3_1) exec_2_0_2 exec_2_1_2)))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_4_0 accu_3_0))
(assert (= accu_4_1 accu_3_1))
...
(assert (= stmt_4_0_1 (ite stmt_3_0_0 (and exec_3_0_0 (not (not (= accu_3_0 #x0000)))) (and stmt_3_0_1 (not exec_3_0_1)))))
(assert (= stmt_4_0_2 (ite stmt_3_0_0 (and exec_3_0_0 (not (= accu_3_0 #x0000))) (and stmt_3_0_2 (not exec_3_0_2)))))

(assert (= stmt_4_1_0 (and stmt_3_1_0 (not exec_3_1_0))))
(assert (= stmt_4_1_1 (ite stmt_3_1_0 (and exec_3_1_0 (not (not (= accu_3_1 #x0000)))) (and stmt_3_1_1 (not exec_3_1_1)))))
(assert (= stmt_4_1_2 (ite stmt_3_1_0 (and exec_3_1_0 (not (= accu_3_1 #x0000))) (and stmt_3_1_2 (not exec_3_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_4_0 (or exec_3_0_1 halt_3_0)))
(assert (= halt_4_1 (or exec_3_1_1 halt_3_1)))

; heap variable - heap_<step>
(assert (= heap_4 (ite flush_3_0 (store heap_3 sb-adr_3_0 sb-val_3_0) (ite flush_3_1 (store heap_3 sb-adr_3_1 sb-val_3_1) heap_3))))

; exit flag variable - exit_<step>
(assert (= exit_4 (or exit_3 (and halt_4_0 halt_4_1) exec_3_0_2 exec_3_1_2)))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_5_0 accu_4_0))
(assert (= accu_5_1 accu_4_1))
...
(assert (= stmt_5_0_1 (ite stmt_4_0_0 (and exec_4_0_0 (not (not (= accu_4_0 #x0000)))) (and stmt_4_0_1 (not exec_4_0_1)))))
(assert (= stmt_5_0_2 (ite stmt_4_0_0 (and exec_4_0_0 (not (= accu_4_0 #x0000))) (and stmt_4_0_2 (not exec_4_0_2)))))

(assert (= stmt_5_1_0 (and stmt_4_1_0 (not exec_4_1_0))))
(assert (= stmt_5_1_1 (ite stmt_4_1_0 (and exec_4_1_0 (not (not (= accu_4_1 #x0000)))) (and stmt_4_1_1 (not exec_4_1_1)))))
(assert (= stmt_5_1_2 (ite stmt_4_1_0 (and exec_4_1_0 (not (= accu_4_1 #x0000))) (and stmt_4_1_2 (not exec_4_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_5_0 (or exec_4_0_1 halt_4_0)))
(assert (= halt_5_1 (or exec_4_1_1 halt_4_1)))

; heap variable - heap_<step>
(assert (= heap_5 (ite flush_4_0 (store heap_4 sb-adr_4_0 sb-val_4_0) (ite flush_4_1 (store heap_4 sb-adr_4_1 sb-val_4_1) heap_4))))

; exit flag variable - exit_<step>
(assert (= exit_5 (or exit_4 (and halt_5_0 halt_5_1) exec_4_0_2 exec_4_1_2)))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_6_0 accu_5_0))
(assert (= accu_6_1 accu_5_1))
...
(assert (= stmt_6_0_1 (ite stmt_5_0_0 (and exec_5_0_0 (not (not (= accu_5_0 #x0000)))) (and stmt_5_0_1 (not exec_5_0_1)))))
(assert (= stmt_6_0_2 (ite stmt_5_0_0 (and exec_5_0_0 (not (= accu_5_0 #x0000))) (and stmt_5_0_2 (not exec_5_0_2)))))

(assert (= stmt_6_1_0 (and stmt_5_1_0 (not exec_5_1_0))))
(assert (= stmt_6_1_1 (ite stmt_5_1_0 (and exec_5_1_0 (not (not (= accu_5_1 #x0000)))) (and stmt_5_1_1 (not exec_5_1_1)))))
(assert (= stmt_6_1_2 (ite stmt_5_1_0 (and exec_5_1_0 (not (= accu_5_1 #x0000))) (and stmt_5_1_2 (not exec_5_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_6_0 (or exec_5_0_1 halt_5_0)))
(assert (= halt_6_1 (or exec_5_1_1 halt_5_1)))

; heap variable - heap_<step>
(assert (= heap_6 (ite flush_5_0 (store heap_5 sb-adr_5_0 sb-val_5_0) (ite flush_5_1 (store heap_5 sb-adr_5_1 sb-val_5_1) heap_5))))

; exit flag variable - exit_<step>
(assert (= exit_6 (or exit_5 (and halt_6_0 halt_6_1) exec_5_0_2 exec_5_1_2)))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_7_0 accu_6_0))
(assert (= accu_7_1 accu_6_1))
...
(assert (= stmt_7_0_1 (ite stmt_6_0_0 (and exec_6_0_0 (not (not (= accu_6_0 #x0000)))) (and stmt_6_0_1 (not exec_6_0_1)))))
(assert (= stmt_7_0_2 (ite stmt_6_0_0 (and exec_6_0_0 (not (= accu_6_0 #x0000))) (and stmt_6_0_2 (not exec_6_0_2)))))

(assert (= stmt_7_1_0 (and stmt_6_1_0 (not exec_6_1_0))))
(assert (= stmt_7_1_1 (ite stmt_6_1_0 (and exec_6_1_0 (not (not (= accu_6_1 #x0000)))) (and stmt_6_1_1 (not exec_6_1_1)))))
(assert (= stmt_7_1_2 (ite stmt_6_1_0 (and exec_6_1_0 (not (= accu_6_1 #x0000))) (and stmt_6_1_2 (not exec_6_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_7_0 (or exec_6_0_1 halt_6_0)))
(assert (= halt_7_1 (or exec_6_1_1 halt_6_1)))

; heap variable - heap_<step>
(assert (= heap_7 (ite flush_6_0 (store heap_6 sb-adr_6_0 sb-val_6_0) (ite flush_6_1 (store heap_6 sb-adr_6_1 sb-val_6_1) heap_6))))

; exit flag variable - exit_<step>
(assert (= exit_7 (or exit_6 (and halt_7_0 halt_7_1) exec_6_0_2 exec_6_1_2)))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_8_0 accu_7_0))
(assert (= accu_8_1 accu_7_1))
...
(assert (= stmt_8_0_1 (ite stmt_7_0_0 (and exec_7_0_0 (not (not (= accu_7_0 #x0000)))) (and stmt_7_0_1 (not exec_7_0_1)))))
(assert (= stmt_8_0_2 (ite stmt_7_0_0 (and exec_7_0_0 (not (= accu_7_0 #x0000))) (and stmt_7_0_2 (not exec_7_0_2)))))

(assert (= stmt_8_1_0 (and stmt_7_1_0 (not exec_7_1_0))))
(assert (= stmt_8_1_1 (ite stmt_7_1_0 (and exec_7_1_0 (not (not (= accu_7_1 #x0000)))) (and stmt_7_1_1 (not exec_7_1_1)))))
(assert (= stmt_8_1_2 (ite stmt_7_1_0 (and exec_7_1_0 (not (= accu_7_1 #x0000))) (and stmt_7_1_2 (not exec_7_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_8_0 (or exec_7_0_1 halt_7_0)))
(assert (= halt_8_1 (or exec_7_1_1 halt_7_1)))

; heap variable - heap_<step>
(assert (= heap_8 (ite flush_7_0 (store heap_7 sb-adr_7_0 sb-val_7_0) (ite flush_7_1 (store heap_7 sb-adr_7_1 sb-val_7_1) heap_7))))

; exit flag variable - exit_<step>
(assert (= exit_8 (or exit_7 (and halt_8_0 halt_8_1) exec_7_0_2 exec_7_1_2)))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_9_0 accu_8_0))
(assert (= accu_9_1 accu_8_1))
...
(assert (= stmt_9_0_1 (ite stmt_8_0_0 (and exec_8_0_0 (not (not (= accu_8_0 #x0000)))) (and stmt_8_0_1 (not exec_8_0_1)))))
(assert (= stmt_9_0_2 (ite stmt_8_0_0 (and exec_8_0_0 (not (= accu_8_0 #x0000))) (and stmt_8_0_2 (not exec_8_0_2)))))

(assert (= stmt_9_1_0 (and stmt_8_1_0 (not exec_8_1_0))))
(assert (= stmt_9_1_1 (ite stmt_8_1_0 (and exec_8_1_0 (not (not (= accu_8_1 #x0000)))) (and stmt_8_1_1 (not exec_8_1_1)))))
(assert (= stmt_9_1_2 (ite stmt_8_1_0 (and exec_8_1_0 (not (= accu_8_1 #x0000))) (and stmt_8_1_2 (not exec_8_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_9_0 (or exec_8_0_1 halt_8_0)))
(assert (= halt_9_1 (or exec_8_1_1 halt_8_1)))

; heap variable - heap_<step>
(assert (= heap_9 (ite flush_8_0 (store heap_8 sb-adr_8_0 sb-val_8_0) (ite flush_8_1 (store heap_8 sb-adr_8_1 sb-val_8_1) heap_8))))

; exit flag variable - exit_<step>
(assert (= exit_9 (or exit_8 (and halt_9_0 halt_9_1) exec_8_0_2 exec_8_1_2)))
...
; accu variables - accu_<step>_<thread>
(assert (= accu_10_0 accu_9_0))
(assert (= accu_10_1 accu_9_1))
...
(assert (= stmt_10_0_1 (ite stmt_9_0_0 (and exec_9_0_0 (not (not (= accu_9_0 #x0000)))) (and stmt_9_0_1 (not exec_9_0_1)))))
(assert (= stmt_10_0_2 (ite stmt_9_0_0 (and exec_9_0_0 (not (= accu_9_0 #x0000))) (and stmt_9_0_2 (not exec_9_0_2)))))

(assert (= stmt_10_1_0 (and stmt_9_1_0 (not exec_9_1_0))))
(assert (= stmt_10_1_1 (ite stmt_9_1_0 (and exec_9_1_0 (not (not (= accu_9_1 #x0000)))) (and stmt_9_1_1 (not exec_9_1_1)))))
(assert (= stmt_10_1_2 (ite stmt_9_1_0 (and exec_9_1_0 (not (= accu_9_1 #x0000))) (and stmt_9_1_2 (not exec_9_1_2)))))

; halt variables - halt_<step>_<thread>
(assert (= halt_10_0 (or exec_9_0_1 halt_9_0)))
(assert (= halt_10_1 (or exec_9_1_1 halt_9_1)))

; heap variable - heap_<step>
(assert (= heap_10 (ite flush_9_0 (store heap_9 sb-adr_9_0 sb-val_9_0) (ite flush_9_1 (store heap_9 sb-adr_9_1 sb-val_9_1) heap_9))))

; exit flag variable - exit_<step>
(assert (= exit_10 (or exit_9 (and halt_10_0 halt_10_1) exec_9_0_2 exec_9_1_2)))
