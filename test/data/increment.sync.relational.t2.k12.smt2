...
(assert (= wait_1_0 (not (or thread_1_0 sync_1_0 sync_1_1))))
...
(assert (= wait_2_0 (not (or thread_2_0 sync_2_0 sync_2_1))))

(assert (=> wait_2_0 (= accu_2_0 accu_1_0)))
(assert (=> wait_2_0 (= mem_2_0 mem_1_0)))

(assert (=> wait_2_0 (= stmt_3_0_0 stmt_2_0_0)))
(assert (=> wait_2_0 (= stmt_3_0_1 stmt_2_0_1)))
(assert (=> wait_2_0 (= stmt_3_0_2 stmt_2_0_2)))
(assert (=> wait_2_0 (= stmt_3_0_3 stmt_2_0_3)))
(assert (=> wait_2_0 (= stmt_3_0_4 stmt_2_0_4)))
(assert (=> wait_2_0 (= stmt_3_0_5 stmt_2_0_5)))
(assert (=> wait_2_0 (= stmt_3_0_6 stmt_2_0_6)))
(assert (=> wait_2_0 (= stmt_3_0_7 stmt_2_0_7)))
...
(declare-fun wait_3_0 () Bool)
(assert (= wait_3_0 (not (or thread_3_0 sync_3_0 sync_3_1))))

(assert (=> wait_3_0 (= accu_3_0 accu_2_0)))
(assert (=> wait_3_0 (= mem_3_0 mem_2_0)))

(assert (=> wait_3_0 (= stmt_4_0_0 stmt_3_0_0)))
(assert (=> wait_3_0 (= stmt_4_0_1 stmt_3_0_1)))
(assert (=> wait_3_0 (= stmt_4_0_2 stmt_3_0_2)))
(assert (=> wait_3_0 (= stmt_4_0_3 stmt_3_0_3)))
(assert (=> wait_3_0 (= stmt_4_0_4 stmt_3_0_4)))
(assert (=> wait_3_0 (= stmt_4_0_5 stmt_3_0_5)))
(assert (=> wait_3_0 (= stmt_4_0_6 stmt_3_0_6)))
(assert (=> wait_3_0 (= stmt_4_0_7 stmt_3_0_7)))
...
(declare-fun wait_4_0 () Bool)
(assert (= wait_4_0 (not (or thread_4_0 sync_4_0 sync_4_1))))

(assert (=> wait_4_0 (= accu_4_0 accu_3_0)))
(assert (=> wait_4_0 (= mem_4_0 mem_3_0)))

(assert (=> wait_4_0 (= stmt_5_0_0 stmt_4_0_0)))
(assert (=> wait_4_0 (= stmt_5_0_1 stmt_4_0_1)))
(assert (=> wait_4_0 (= stmt_5_0_2 stmt_4_0_2)))
(assert (=> wait_4_0 (= stmt_5_0_3 stmt_4_0_3)))
(assert (=> wait_4_0 (= stmt_5_0_4 stmt_4_0_4)))
(assert (=> wait_4_0 (= stmt_5_0_5 stmt_4_0_5)))
(assert (=> wait_4_0 (= stmt_5_0_6 stmt_4_0_6)))
(assert (=> wait_4_0 (= stmt_5_0_7 stmt_4_0_7)))
...
(declare-fun wait_5_0 () Bool)
(assert (= wait_5_0 (not (or thread_5_0 sync_5_0 sync_5_1))))

(assert (=> wait_5_0 (= accu_5_0 accu_4_0)))
(assert (=> wait_5_0 (= mem_5_0 mem_4_0)))

(assert (=> wait_5_0 (= stmt_6_0_0 stmt_5_0_0)))
(assert (=> wait_5_0 (= stmt_6_0_1 stmt_5_0_1)))
(assert (=> wait_5_0 (= stmt_6_0_2 stmt_5_0_2)))
(assert (=> wait_5_0 (= stmt_6_0_3 stmt_5_0_3)))
(assert (=> wait_5_0 (= stmt_6_0_4 stmt_5_0_4)))
(assert (=> wait_5_0 (= stmt_6_0_5 stmt_5_0_5)))
(assert (=> wait_5_0 (= stmt_6_0_6 stmt_5_0_6)))
(assert (=> wait_5_0 (= stmt_6_0_7 stmt_5_0_7)))
...
(declare-fun wait_6_0 () Bool)
(assert (= wait_6_0 (not (or thread_6_0 sync_6_0 sync_6_1))))

(assert (=> wait_6_0 (= accu_6_0 accu_5_0)))
(assert (=> wait_6_0 (= mem_6_0 mem_5_0)))

(assert (=> wait_6_0 (= stmt_7_0_0 stmt_6_0_0)))
(assert (=> wait_6_0 (= stmt_7_0_1 stmt_6_0_1)))
(assert (=> wait_6_0 (= stmt_7_0_2 stmt_6_0_2)))
(assert (=> wait_6_0 (= stmt_7_0_3 stmt_6_0_3)))
(assert (=> wait_6_0 (= stmt_7_0_4 stmt_6_0_4)))
(assert (=> wait_6_0 (= stmt_7_0_5 stmt_6_0_5)))
(assert (=> wait_6_0 (= stmt_7_0_6 stmt_6_0_6)))
(assert (=> wait_6_0 (= stmt_7_0_7 stmt_6_0_7)))
...
(declare-fun wait_7_0 () Bool)
(assert (= wait_7_0 (not (or thread_7_0 sync_7_0 sync_7_1))))

(assert (=> wait_7_0 (= accu_7_0 accu_6_0)))
(assert (=> wait_7_0 (= mem_7_0 mem_6_0)))

(assert (=> wait_7_0 (= stmt_8_0_0 stmt_7_0_0)))
(assert (=> wait_7_0 (= stmt_8_0_1 stmt_7_0_1)))
(assert (=> wait_7_0 (= stmt_8_0_2 stmt_7_0_2)))
(assert (=> wait_7_0 (= stmt_8_0_3 stmt_7_0_3)))
(assert (=> wait_7_0 (= stmt_8_0_4 stmt_7_0_4)))
(assert (=> wait_7_0 (= stmt_8_0_5 stmt_7_0_5)))
(assert (=> wait_7_0 (= stmt_8_0_6 stmt_7_0_6)))
(assert (=> wait_7_0 (= stmt_8_0_7 stmt_7_0_7)))
...
(declare-fun wait_8_0 () Bool)
(assert (= wait_8_0 (not (or thread_8_0 sync_8_0 sync_8_1))))

(assert (=> wait_8_0 (= accu_8_0 accu_7_0)))
(assert (=> wait_8_0 (= mem_8_0 mem_7_0)))

(assert (=> wait_8_0 (= stmt_9_0_0 stmt_8_0_0)))
(assert (=> wait_8_0 (= stmt_9_0_1 stmt_8_0_1)))
(assert (=> wait_8_0 (= stmt_9_0_2 stmt_8_0_2)))
(assert (=> wait_8_0 (= stmt_9_0_3 stmt_8_0_3)))
(assert (=> wait_8_0 (= stmt_9_0_4 stmt_8_0_4)))
(assert (=> wait_8_0 (= stmt_9_0_5 stmt_8_0_5)))
(assert (=> wait_8_0 (= stmt_9_0_6 stmt_8_0_6)))
(assert (=> wait_8_0 (= stmt_9_0_7 stmt_8_0_7)))
...
(declare-fun wait_9_0 () Bool)
(assert (= wait_9_0 (not (or thread_9_0 sync_9_0 sync_9_1))))

(assert (=> wait_9_0 (= accu_9_0 accu_8_0)))
(assert (=> wait_9_0 (= mem_9_0 mem_8_0)))

(assert (=> wait_9_0 (= stmt_10_0_0 stmt_9_0_0)))
(assert (=> wait_9_0 (= stmt_10_0_1 stmt_9_0_1)))
(assert (=> wait_9_0 (= stmt_10_0_2 stmt_9_0_2)))
(assert (=> wait_9_0 (= stmt_10_0_3 stmt_9_0_3)))
(assert (=> wait_9_0 (= stmt_10_0_4 stmt_9_0_4)))
(assert (=> wait_9_0 (= stmt_10_0_5 stmt_9_0_5)))
(assert (=> wait_9_0 (= stmt_10_0_6 stmt_9_0_6)))
(assert (=> wait_9_0 (= stmt_10_0_7 stmt_9_0_7)))
...
(declare-fun wait_10_0 () Bool)
(assert (= wait_10_0 (not (or thread_10_0 sync_10_0 sync_10_1))))

(assert (=> wait_10_0 (= accu_10_0 accu_9_0)))
(assert (=> wait_10_0 (= mem_10_0 mem_9_0)))

(assert (=> wait_10_0 (= stmt_11_0_0 stmt_10_0_0)))
(assert (=> wait_10_0 (= stmt_11_0_1 stmt_10_0_1)))
(assert (=> wait_10_0 (= stmt_11_0_2 stmt_10_0_2)))
(assert (=> wait_10_0 (= stmt_11_0_3 stmt_10_0_3)))
(assert (=> wait_10_0 (= stmt_11_0_4 stmt_10_0_4)))
(assert (=> wait_10_0 (= stmt_11_0_5 stmt_10_0_5)))
(assert (=> wait_10_0 (= stmt_11_0_6 stmt_10_0_6)))
(assert (=> wait_10_0 (= stmt_11_0_7 stmt_10_0_7)))
...
(declare-fun wait_11_0 () Bool)
(assert (= wait_11_0 (not (or thread_11_0 sync_11_0 sync_11_1))))

(assert (=> wait_11_0 (= accu_11_0 accu_10_0)))
(assert (=> wait_11_0 (= mem_11_0 mem_10_0)))

(assert (=> wait_11_0 (= stmt_12_0_0 stmt_11_0_0)))
(assert (=> wait_11_0 (= stmt_12_0_1 stmt_11_0_1)))
(assert (=> wait_11_0 (= stmt_12_0_2 stmt_11_0_2)))
(assert (=> wait_11_0 (= stmt_12_0_3 stmt_11_0_3)))
(assert (=> wait_11_0 (= stmt_12_0_4 stmt_11_0_4)))
(assert (=> wait_11_0 (= stmt_12_0_5 stmt_11_0_5)))
(assert (=> wait_11_0 (= stmt_12_0_6 stmt_11_0_6)))
(assert (=> wait_11_0 (= stmt_12_0_7 stmt_11_0_7)))
...
(declare-fun wait_12_0 () Bool)
(assert (= wait_12_0 (not (or thread_12_0 sync_12_0 sync_12_1))))

(assert (=> wait_12_0 (= accu_12_0 accu_11_0)))
(assert (=> wait_12_0 (= mem_12_0 mem_11_0)))
