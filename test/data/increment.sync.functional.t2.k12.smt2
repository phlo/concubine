...
(assert (= stmt_9_1_1 (ite stmt_8_1_6 (and exec_8_1_6 (not (= accu_8_1 #x0000))) (ite stmt_8_1_0 exec_8_1_0 (and stmt_8_1_1 (not exec_8_1_1))))))
...
(assert (= stmt_9_1_7 (ite stmt_8_1_6 (and exec_8_1_6 (not (not (= accu_8_1 #x0000)))) (and stmt_8_1_7 (not exec_8_1_7)))))

(assert (= stmt_9_2_0 (ite stmt_8_2_5 (and exec_8_2_5 (not (= accu_8_2 #x0000))) (and stmt_8_2_0 (not exec_8_2_0)))))
...
(assert (= stmt_9_2_6 (ite stmt_8_2_5 (and exec_8_2_5 (not (not (= accu_8_2 #x0000)))) (and stmt_8_2_6 (not exec_8_2_6)))))
...
(assert (= accu_9_2 (ite exec_9_2_2 (select heap_8 #x0000) (ite exec_9_2_3 (bvadd accu_8_2 #x0001) accu_8_2))))
...
(assert (= heap_9 (ite exec_9_1_0 (store heap_8 #x0000 accu_8_1) (ite exec_9_1_4 (store heap_8 #x0000 accu_8_1) (ite exec_9_2_4 (store heap_8 #x0000 accu_8_2) heap_8)))))
...
(assert (= stmt_10_1_1 (ite stmt_9_1_6 (and exec_9_1_6 (not (= accu_9_1 #x0000))) (ite stmt_9_1_0 exec_9_1_0 (and stmt_9_1_1 (not exec_9_1_1))))))
...
(assert (= stmt_10_1_7 (ite stmt_9_1_6 (and exec_9_1_6 (not (not (= accu_9_1 #x0000)))) (and stmt_9_1_7 (not exec_9_1_7)))))

(assert (= stmt_10_2_0 (ite stmt_9_2_5 (and exec_9_2_5 (not (= accu_9_2 #x0000))) (and stmt_9_2_0 (not exec_9_2_0)))))
...
(assert (= stmt_10_2_6 (ite stmt_9_2_5 (and exec_9_2_5 (not (not (= accu_9_2 #x0000)))) (and stmt_9_2_6 (not exec_9_2_6)))))
...
(assert (= accu_10_2 (ite exec_10_2_2 (select heap_9 #x0000) (ite exec_10_2_3 (bvadd accu_9_2 #x0001) accu_9_2))))
...
(assert (= heap_10 (ite exec_10_1_0 (store heap_9 #x0000 accu_9_1) (ite exec_10_1_4 (store heap_9 #x0000 accu_9_1) (ite exec_10_2_4 (store heap_9 #x0000 accu_9_2) heap_9)))))
...
(assert (= stmt_11_1_1 (ite stmt_10_1_6 (and exec_10_1_6 (not (= accu_10_1 #x0000))) (ite stmt_10_1_0 exec_10_1_0 (and stmt_10_1_1 (not exec_10_1_1))))))
...
(assert (= stmt_11_1_7 (ite stmt_10_1_6 (and exec_10_1_6 (not (not (= accu_10_1 #x0000)))) (and stmt_10_1_7 (not exec_10_1_7)))))

(assert (= stmt_11_2_0 (ite stmt_10_2_5 (and exec_10_2_5 (not (= accu_10_2 #x0000))) (and stmt_10_2_0 (not exec_10_2_0)))))
...
(assert (= stmt_11_2_6 (ite stmt_10_2_5 (and exec_10_2_5 (not (not (= accu_10_2 #x0000)))) (and stmt_10_2_6 (not exec_10_2_6)))))
...
(assert (= accu_11_2 (ite exec_11_2_2 (select heap_10 #x0000) (ite exec_11_2_3 (bvadd accu_10_2 #x0001) accu_10_2))))
...
(assert (= heap_11 (ite exec_11_1_0 (store heap_10 #x0000 accu_10_1) (ite exec_11_1_4 (store heap_10 #x0000 accu_10_1) (ite exec_11_2_4 (store heap_10 #x0000 accu_10_2) heap_10)))))
...
(assert (= stmt_12_1_1 (ite stmt_11_1_6 (and exec_11_1_6 (not (= accu_11_1 #x0000))) (ite stmt_11_1_0 exec_11_1_0 (and stmt_11_1_1 (not exec_11_1_1))))))
...
(assert (= stmt_12_1_7 (ite stmt_11_1_6 (and exec_11_1_6 (not (not (= accu_11_1 #x0000)))) (and stmt_11_1_7 (not exec_11_1_7)))))

(assert (= stmt_12_2_0 (ite stmt_11_2_5 (and exec_11_2_5 (not (= accu_11_2 #x0000))) (and stmt_11_2_0 (not exec_11_2_0)))))
...
(assert (= stmt_12_2_6 (ite stmt_11_2_5 (and exec_11_2_5 (not (not (= accu_11_2 #x0000)))) (and stmt_11_2_6 (not exec_11_2_6)))))
...
(assert (= accu_12_2 (ite exec_12_2_2 (select heap_11 #x0000) (ite exec_12_2_3 (bvadd accu_11_2 #x0001) accu_11_2))))
...
(assert (= heap_12 (ite exec_12_1_0 (store heap_11 #x0000 accu_11_1) (ite exec_12_1_4 (store heap_11 #x0000 accu_11_1) (ite exec_12_2_4 (store heap_11 #x0000 accu_11_2) heap_11)))))
