...
|     |                 |                                       |
| 134 | count           | run.sh buggy 2 2 btormc btor2         |
| 135 | count           | run.sh buggy 2 2 boolector functional |
| 136 | count           | run.sh buggy 2 2 boolector relational |
| 137 | count           | run.sh buggy 2 2 cvc4 functional      |
| 138 | count           | run.sh buggy 2 2 cvc4 relational      |
| 139 | count           | run.sh buggy 2 2 z3 functional        |
| 140 | count           | run.sh buggy 2 2 z3 relational        |
|     |                 |                                       |
| 141 | count           | run.sh buggy 2 3 btormc btor2         |
| 142 | count           | run.sh buggy 2 3 boolector functional |
| 143 | count           | run.sh buggy 2 3 boolector relational |
| 144 | count           | run.sh buggy 2 3 cvc4 functional      |
| 145 | count           | run.sh buggy 2 3 cvc4 relational      |
| 146 | count           | run.sh buggy 2 3 z3 functional        |
| 147 | count           | run.sh buggy 2 3 z3 relational        |
|     |                 |                                       |
| 148 | count           | run.sh buggy 2 4 btormc btor2         |
| 149 | count           | run.sh buggy 2 4 boolector functional |
| 150 | count           | run.sh buggy 2 4 boolector relational |
| 151 | count           | run.sh buggy 2 4 cvc4 functional      |
| 152 | count           | run.sh buggy 2 4 cvc4 relational      |
| 153 | count           | run.sh buggy 2 4 z3 functional        |
| 154 | count           | run.sh buggy 2 4 z3 relational        |
|     |                 |                                       |
| 155 | count           | run.sh buggy 3 2 btormc btor2         |
| 156 | count           | run.sh buggy 3 2 boolector functional |
| 157 | count           | run.sh buggy 3 2 boolector relational |
| 158 | count           | run.sh buggy 3 2 cvc4 functional      |
| 159 | count           | run.sh buggy 3 2 cvc4 relational      |
| 160 | count           | run.sh buggy 3 2 z3 functional        |
| 161 | count           | run.sh buggy 3 2 z3 relational        |
|     |                 |                                       |
| 162 | count           | run.sh buggy 3 3 btormc btor2         |
| 163 | count           | run.sh buggy 3 3 boolector functional |
| 164 | count           | run.sh buggy 3 3 boolector relational |
| 165 | count           | run.sh buggy 3 3 cvc4 functional      |
| 166 | count           | run.sh buggy 3 3 cvc4 relational      |
| 167 | count           | run.sh buggy 3 3 z3 functional        |
| 168 | count           | run.sh buggy 3 3 z3 relational        |
|     |                 |                                       |
| 169 | count           | run.sh buggy 3 4 btormc btor2         |
| 170 | count           | run.sh buggy 3 4 boolector functional |
| 171 | count           | run.sh buggy 3 4 boolector relational |
| 172 | count           | run.sh buggy 3 4 cvc4 functional      |
| 173 | count           | run.sh buggy 3 4 cvc4 relational      |
| 174 | count           | run.sh buggy 3 4 z3 functional        |
| 175 | count           | run.sh buggy 3 4 z3 relational        |
|     |                 |                                       |
| 176 | count           | run.sh buggy 4 2 btormc btor2         |
| 177 | count           | run.sh buggy 4 2 boolector functional |
| 178 | count           | run.sh buggy 4 2 boolector relational |
| 179 | count           | run.sh buggy 4 2 cvc4 functional      |
| 180 | count           | run.sh buggy 4 2 cvc4 relational      |
| 181 | count           | run.sh buggy 4 2 z3 functional        |
| 182 | count           | run.sh buggy 4 2 z3 relational        |
|     |                 |                                       |
| 183 | count           | run.sh buggy 4 3 btormc btor2         |
| 184 | count           | run.sh buggy 4 3 boolector functional |
| 185 | count           | run.sh buggy 4 3 boolector relational |
| 186 | count           | run.sh buggy 4 3 cvc4 functional      |
| 187 | count           | run.sh buggy 4 3 cvc4 relational      |
| 188 | count           | run.sh buggy 4 3 z3 functional        |
| 189 | count           | run.sh buggy 4 3 z3 relational        |
|     |                 |                                       |
| 190 | count           | run.sh buggy 4 4 btormc btor2         |
| 191 | count           | run.sh buggy 4 4 boolector functional |
| 192 | count           | run.sh buggy 4 4 boolector relational |
| 193 | count           | run.sh buggy 4 4 cvc4 functional      |
| 194 | count           | run.sh buggy 4 4 cvc4 relational      |
| 195 | count           | run.sh buggy 4 4 z3 functional        |
| 196 | count           | run.sh buggy 4 4 z3 relational        |
|     |                 |                                       |
| 197 | count           | run.sh cas 2 2 btormc btor2           |
| 198 | count           | run.sh cas 2 2 boolector functional   |
| 199 | count           | run.sh cas 2 2 boolector relational   |
| 200 | count           | run.sh cas 2 2 cvc4 functional        |
| 201 | count           | run.sh cas 2 2 cvc4 relational        |
| 202 | count           | run.sh cas 2 2 z3 functional          |
| 203 | count           | run.sh cas 2 2 z3 relational          |
|     |                 |                                       |
| 204 | count           | run.sh cas 2 3 btormc btor2           |
| 205 | count           | run.sh cas 2 3 boolector functional   |
| 206 | count           | run.sh cas 2 3 boolector relational   |
| 207 | count           | run.sh cas 2 3 cvc4 functional        |
| 208 | count           | run.sh cas 2 3 cvc4 relational        |
| 209 | count           | run.sh cas 2 3 z3 functional          |
| 210 | count           | run.sh cas 2 3 z3 relational          |
|     |                 |                                       |
| 211 | count           | run.sh cas 2 4 btormc btor2           |
| 212 | count           | run.sh cas 2 4 boolector functional   |
| 213 | count           | run.sh cas 2 4 boolector relational   |
| 214 | count           | run.sh cas 2 4 cvc4 functional        |
| 215 | count           | run.sh cas 2 4 cvc4 relational        |
| 216 | count           | run.sh cas 2 4 z3 functional          |
| 217 | count           | run.sh cas 2 4 z3 relational          |
|     |                 |                                       |
| 218 | count           | run.sh cas 3 2 btormc btor2           |
| 219 | count           | run.sh cas 3 2 boolector functional   |
| 220 | count           | run.sh cas 3 2 boolector relational   |
| 221 | count           | run.sh cas 3 2 cvc4 functional        |
| 222 | count           | run.sh cas 3 2 cvc4 relational        |
| 223 | count           | run.sh cas 3 2 z3 functional          |
| 224 | count           | run.sh cas 3 2 z3 relational          |
|     |                 |                                       |
| 225 | count           | run.sh cas 3 3 btormc btor2           |
| 226 | count           | run.sh cas 3 3 boolector functional   |
| 227 | count           | run.sh cas 3 3 boolector relational   |
| 228 | count           | run.sh cas 3 3 cvc4 functional        |
| 229 | count           | run.sh cas 3 3 cvc4 relational        |
| 230 | count           | run.sh cas 3 3 z3 functional          |
| 231 | count           | run.sh cas 3 3 z3 relational          |
|     |                 |                                       |
| 232 | count           | run.sh cas 3 4 btormc btor2           |
| 233 | count           | run.sh cas 3 4 boolector functional   |
| 234 | count           | run.sh cas 3 4 boolector relational   |
| 235 | count           | run.sh cas 3 4 cvc4 functional        |
| 236 | count           | run.sh cas 3 4 cvc4 relational        |
| 237 | count           | run.sh cas 3 4 z3 functional          |
| 238 | count           | run.sh cas 3 4 z3 relational          |
|     |                 |                                       |
| 239 | count           | run.sh cas 4 2 btormc btor2           |
| 240 | count           | run.sh cas 4 2 boolector functional   |
| 241 | count           | run.sh cas 4 2 boolector relational   |
| 242 | count           | run.sh cas 4 2 cvc4 functional        |
| 243 | count           | run.sh cas 4 2 cvc4 relational        |
| 244 | count           | run.sh cas 4 2 z3 functional          |
| 245 | count           | run.sh cas 4 2 z3 relational          |
|     |                 |                                       |
| 246 | count           | run.sh cas 4 3 btormc btor2           |
| 247 | count           | run.sh cas 4 3 boolector functional   |
| 248 | count           | run.sh cas 4 3 boolector relational   |
| 249 | count           | run.sh cas 4 3 cvc4 functional        |
| 250 | count           | run.sh cas 4 3 cvc4 relational        |
| 251 | count           | run.sh cas 4 3 z3 functional          |
| 252 | count           | run.sh cas 4 3 z3 relational          |
|     |                 |                                       |
| 253 | count           | run.sh cas 4 4 btormc btor2           |
| 254 | count           | run.sh cas 4 4 boolector functional   |
| 255 | count           | run.sh cas 4 4 boolector relational   |
| 256 | count           | run.sh cas 4 4 cvc4 functional        |
| 257 | count           | run.sh cas 4 4 cvc4 relational        |
| 258 | count           | run.sh cas 4 4 z3 functional          |
| 259 | count           | run.sh cas 4 4 z3 relational          |
