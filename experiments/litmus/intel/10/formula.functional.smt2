...
(assert (= accu_1_1 (ite exec_0_1_0 (ite (and sb-full_0_1 (= sb-adr_0_1 #x0001)) sb-val_0_1 (select heap_0 #x0001)) (ite exec_0_1_1 (ite (and sb-full_0_1 (= sb-adr_0_1 #x0000)) sb-val_0_1 (select heap_0 #x0000)) accu_0_1))))
...
; heap variable - heap_<step>
(assert (= heap_1 (ite flush_0_0 (store heap_0 sb-adr_0_0 sb-val_0_0) (ite exec_0_0_1 (ite (= mem_0_0 (select heap_0 #x0000)) (store heap_0 #x0000 accu_0_0) heap_0) (ite flush_0_1 (store heap_0 sb-adr_0_1 sb-val_0_1) heap_0)))))
...
(assert (= accu_2_1 (ite exec_1_1_0 (ite (and sb-full_1_1 (= sb-adr_1_1 #x0001)) sb-val_1_1 (select heap_1 #x0001)) (ite exec_1_1_1 (ite (and sb-full_1_1 (= sb-adr_1_1 #x0000)) sb-val_1_1 (select heap_1 #x0000)) accu_1_1))))
...
; heap variable - heap_<step>
(assert (= heap_2 (ite flush_1_0 (store heap_1 sb-adr_1_0 sb-val_1_0) (ite exec_1_0_1 (ite (= mem_1_0 (select heap_1 #x0000)) (store heap_1 #x0000 accu_1_0) heap_1) (ite flush_1_1 (store heap_1 sb-adr_1_1 sb-val_1_1) heap_1)))))
...
(assert (= accu_3_1 (ite exec_2_1_0 (ite (and sb-full_2_1 (= sb-adr_2_1 #x0001)) sb-val_2_1 (select heap_2 #x0001)) (ite exec_2_1_1 (ite (and sb-full_2_1 (= sb-adr_2_1 #x0000)) sb-val_2_1 (select heap_2 #x0000)) accu_2_1))))
...
; heap variable - heap_<step>
(assert (= heap_3 (ite flush_2_0 (store heap_2 sb-adr_2_0 sb-val_2_0) (ite exec_2_0_1 (ite (= mem_2_0 (select heap_2 #x0000)) (store heap_2 #x0000 accu_2_0) heap_2) (ite flush_2_1 (store heap_2 sb-adr_2_1 sb-val_2_1) heap_2)))))
...
(assert (= accu_4_1 (ite exec_3_1_0 (ite (and sb-full_3_1 (= sb-adr_3_1 #x0001)) sb-val_3_1 (select heap_3 #x0001)) (ite exec_3_1_1 (ite (and sb-full_3_1 (= sb-adr_3_1 #x0000)) sb-val_3_1 (select heap_3 #x0000)) accu_3_1))))
...
; heap variable - heap_<step>
(assert (= heap_4 (ite flush_3_0 (store heap_3 sb-adr_3_0 sb-val_3_0) (ite exec_3_0_1 (ite (= mem_3_0 (select heap_3 #x0000)) (store heap_3 #x0000 accu_3_0) heap_3) (ite flush_3_1 (store heap_3 sb-adr_3_1 sb-val_3_1) heap_3)))))
...
(assert (= accu_5_1 (ite exec_4_1_0 (ite (and sb-full_4_1 (= sb-adr_4_1 #x0001)) sb-val_4_1 (select heap_4 #x0001)) (ite exec_4_1_1 (ite (and sb-full_4_1 (= sb-adr_4_1 #x0000)) sb-val_4_1 (select heap_4 #x0000)) accu_4_1))))
...
; heap variable - heap_<step>
(assert (= heap_5 (ite flush_4_0 (store heap_4 sb-adr_4_0 sb-val_4_0) (ite exec_4_0_1 (ite (= mem_4_0 (select heap_4 #x0000)) (store heap_4 #x0000 accu_4_0) heap_4) (ite flush_4_1 (store heap_4 sb-adr_4_1 sb-val_4_1) heap_4)))))
...
(assert (= accu_6_1 (ite exec_5_1_0 (ite (and sb-full_5_1 (= sb-adr_5_1 #x0001)) sb-val_5_1 (select heap_5 #x0001)) (ite exec_5_1_1 (ite (and sb-full_5_1 (= sb-adr_5_1 #x0000)) sb-val_5_1 (select heap_5 #x0000)) accu_5_1))))
...
; heap variable - heap_<step>
(assert (= heap_6 (ite flush_5_0 (store heap_5 sb-adr_5_0 sb-val_5_0) (ite exec_5_0_1 (ite (= mem_5_0 (select heap_5 #x0000)) (store heap_5 #x0000 accu_5_0) heap_5) (ite flush_5_1 (store heap_5 sb-adr_5_1 sb-val_5_1) heap_5)))))
...
(assert (= accu_7_1 (ite exec_6_1_0 (ite (and sb-full_6_1 (= sb-adr_6_1 #x0001)) sb-val_6_1 (select heap_6 #x0001)) (ite exec_6_1_1 (ite (and sb-full_6_1 (= sb-adr_6_1 #x0000)) sb-val_6_1 (select heap_6 #x0000)) accu_6_1))))
...
; heap variable - heap_<step>
(assert (= heap_7 (ite flush_6_0 (store heap_6 sb-adr_6_0 sb-val_6_0) (ite exec_6_0_1 (ite (= mem_6_0 (select heap_6 #x0000)) (store heap_6 #x0000 accu_6_0) heap_6) (ite flush_6_1 (store heap_6 sb-adr_6_1 sb-val_6_1) heap_6)))))
...
(assert (= accu_8_1 (ite exec_7_1_0 (ite (and sb-full_7_1 (= sb-adr_7_1 #x0001)) sb-val_7_1 (select heap_7 #x0001)) (ite exec_7_1_1 (ite (and sb-full_7_1 (= sb-adr_7_1 #x0000)) sb-val_7_1 (select heap_7 #x0000)) accu_7_1))))
...
; heap variable - heap_<step>
(assert (= heap_8 (ite flush_7_0 (store heap_7 sb-adr_7_0 sb-val_7_0) (ite exec_7_0_1 (ite (= mem_7_0 (select heap_7 #x0000)) (store heap_7 #x0000 accu_7_0) heap_7) (ite flush_7_1 (store heap_7 sb-adr_7_1 sb-val_7_1) heap_7)))))
