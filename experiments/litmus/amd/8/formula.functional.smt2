...
(assert (= mem_1_1 (ite exec_0_1_2 (ite (and sb-full_0_1 (= sb-adr_0_1 #x0001)) sb-val_0_1 (select heap_0 #x0001)) mem_0_1)))
...
(assert (= mem_2_1 (ite exec_1_1_2 (ite (and sb-full_1_1 (= sb-adr_1_1 #x0001)) sb-val_1_1 (select heap_1 #x0001)) mem_1_1)))
...
(assert (= mem_3_1 (ite exec_2_1_2 (ite (and sb-full_2_1 (= sb-adr_2_1 #x0001)) sb-val_2_1 (select heap_2 #x0001)) mem_2_1)))
...
(assert (= mem_4_1 (ite exec_3_1_2 (ite (and sb-full_3_1 (= sb-adr_3_1 #x0001)) sb-val_3_1 (select heap_3 #x0001)) mem_3_1)))
...
(assert (= mem_5_1 (ite exec_4_1_2 (ite (and sb-full_4_1 (= sb-adr_4_1 #x0001)) sb-val_4_1 (select heap_4 #x0001)) mem_4_1)))
...
(assert (= mem_6_1 (ite exec_5_1_2 (ite (and sb-full_5_1 (= sb-adr_5_1 #x0001)) sb-val_5_1 (select heap_5 #x0001)) mem_5_1)))
...
(assert (= mem_7_1 (ite exec_6_1_2 (ite (and sb-full_6_1 (= sb-adr_6_1 #x0001)) sb-val_6_1 (select heap_6 #x0001)) mem_6_1)))
...
(assert (= mem_8_1 (ite exec_7_1_2 (ite (and sb-full_7_1 (= sb-adr_7_1 #x0001)) sb-val_7_1 (select heap_7 #x0001)) mem_7_1)))
...
(assert (= mem_9_1 (ite exec_8_1_2 (ite (and sb-full_8_1 (= sb-adr_8_1 #x0001)) sb-val_8_1 (select heap_8 #x0001)) mem_8_1)))
...
(assert (= mem_10_1 (ite exec_9_1_2 (ite (and sb-full_9_1 (= sb-adr_9_1 #x0001)) sb-val_9_1 (select heap_9 #x0001)) mem_9_1)))
...
(assert (= mem_11_1 (ite exec_10_1_2 (ite (and sb-full_10_1 (= sb-adr_10_1 #x0001)) sb-val_10_1 (select heap_10 #x0001)) mem_10_1)))
...
(assert (= mem_12_1 (ite exec_11_1_2 (ite (and sb-full_11_1 (= sb-adr_11_1 #x0001)) sb-val_11_1 (select heap_11 #x0001)) mem_11_1)))
